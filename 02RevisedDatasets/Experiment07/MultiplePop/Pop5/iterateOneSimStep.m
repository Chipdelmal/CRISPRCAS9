...
% Initial conditions (population 5):
...
for t = 51:max_t
    ...
    thetaLA = thetaL;
    for i=1:TL
        thetaLA = thetaLA*((alpha/(alpha+L5(t-i)))^(1/TL));
    end
    
    L5(t) = max(0,binornd(L5(t-1),(1-mu_l)*((alpha/(alpha+L5(t-1)))^(1/TL))) + binornd(poissrnd( beta_HH*MHH_HH5(t-T0) + beta_HH*MHH_Hh5(t-T0) + beta_HH*MHH_HR5(t-T0) + beta_HH*MHH_hh5(t-T0) + beta_HH*MHH_hR5(t-T0) + beta_HH*MHH_RR5(t-T0)  +  beta_Hh*MHh_HH5(t-T0) + beta_Hh*MHh_Hh5(t-T0) + beta_Hh*MHh_HR5(t-T0) + beta_Hh*MHh_hh5(t-T0) + beta_Hh*MHh_hR5(t-T0) + beta_Hh*MHh_RR5(t-T0)  +  beta_HR*MHR_HH5(t-T0) + beta_HR*MHR_Hh5(t-T0) + beta_HR*MHR_HR5(t-T0) + beta_HR*MHR_hh5(t-T0) + beta_HR*MHR_hR5(t-T0) + beta_HR*MHR_RR5(t-T0)  +  beta_hh*Mhh_HH5(t-T0) + beta_hh*Mhh_Hh5(t-T0) + beta_hh*Mhh_HR5(t-T0) + beta_hh*Mhh_hh5(t-T0) + beta_hh*Mhh_hR5(t-T0) + beta_hh*Mhh_RR5(t-T0)  +  beta_hR*MhR_HH5(t-T0) + beta_hR*MhR_Hh5(t-T0) + beta_hR*MhR_HR5(t-T0) + beta_hR*MhR_hh5(t-T0) + beta_hR*MhR_hR5(t-T0) + beta_hR*MhR_RR5(t-T0)  +  beta_RR*MRR_HH5(t-T0) + beta_RR*MRR_Hh5(t-T0) + beta_RR*MRR_HR5(t-T0) + beta_RR*MRR_hh5(t-T0) + beta_RR*MRR_hR5(t-T0) + beta_RR*MRR_RR5(t-T0)  ),theta0) - binornd(poissrnd(beta_HH*MHH_HH5(t-T0-TL) + beta_HH*MHH_Hh5(t-T0-TL) + beta_HH*MHH_HR5(t-T0-TL) + beta_HH*MHH_hh5(t-T0-TL) + beta_HH*MHH_hR5(t-T0-TL) + beta_HH*MHH_RR5(t-T0-TL)  +  beta_Hh*MHh_HH5(t-T0-TL) + beta_Hh*MHh_Hh5(t-T0-TL) + beta_Hh*MHh_HR5(t-T0-TL) + beta_Hh*MHh_hh5(t-T0-TL) + beta_Hh*MHh_hR5(t-T0-TL) + beta_Hh*MHh_RR5(t-T0-TL)  +  beta_HR*MHR_HH5(t-T0-TL) + beta_HR*MHR_Hh5(t-T0-TL) + beta_HR*MHR_HR5(t-T0-TL) + beta_HR*MHR_hh5(t-T0-TL) + beta_HR*MHR_hR5(t-T0-TL) + beta_HR*MHR_RR5(t-T0-TL)  +  beta_hh*Mhh_HH5(t-T0-TL) + beta_hh*Mhh_Hh5(t-T0-TL) + beta_hh*Mhh_HR5(t-T0-TL) + beta_hh*Mhh_hh5(t-T0-TL) + beta_hh*Mhh_hR5(t-T0-TL) + beta_hh*Mhh_RR5(t-T0-TL)  +  beta_hR*MhR_HH5(t-T0-TL) + beta_hR*MhR_Hh5(t-T0-TL) + beta_hR*MhR_HR5(t-T0-TL) + beta_hR*MhR_hh5(t-T0-TL) + beta_hR*MhR_hR5(t-T0-TL) + beta_hR*MhR_RR5(t-T0-TL)  +  beta_RR*MRR_HH5(t-T0-TL) + beta_RR*MRR_Hh5(t-T0-TL) + beta_RR*MRR_HR5(t-T0-TL) + beta_RR*MRR_hh5(t-T0-TL) + beta_RR*MRR_hR5(t-T0-TL) + beta_RR*MRR_RR5(t-T0-TL) ),theta0*thetaLA));
    
    thetaLA = thetaL;
    for i=1:TL
        thetaLA = thetaLA*((alpha/(alpha+L5(t-i-TP)))^(1/TL));
    end
    
    % Eggs produced by HH females:
    
    E_HHHH5 = poissrnd(beta_HH*MHH_HH5(t-T0-TL-TP));
    E_HHHH_HH5 = E_HHHH5;

    E_HHHh5 = mnrnd(poissrnd(beta_HH*MHH_Hh5(t-T0-TL-TP)),[((1+e)/2),((1-e-rho)/2),(rho/2)]);
    E_HHHh_HH5 = E_HHHh5(1); E_HHHh_Hh5 = E_HHHh5(2); E_HHHh_HR5 = E_HHHh5(3);

    E_HHHR5 = mnrnd(poissrnd(beta_HH*MHH_HR5(t-T0-TL-TP)),[(1/2),(1/2)]);
    E_HHHR_HH5 = E_HHHR5(1); E_HHHR_HR5 = E_HHHR5(2);
    ...
    E_HHRR5 = poissrnd(beta_HH*MHH_RR5(t-T0-TL-TP));
    E_HHRR_HR5 = E_HHRR5;
    ...
    E_HhHh5 = mnrnd(poissrnd(beta_Hh*MHh_Hh5(t-T0-TL-TP)),[(((1+e)^2)/4),((1+e)*(1-e-rho)/2),((1+e)*rho/2),(((1-e-rho)^2)/4),((1-e-rho)*rho/2),((rho^2)/4)]);
    E_HhHh_HH5 = E_HhHh5(1); E_HhHh_Hh5 = E_HhHh5(2); E_HhHh_HR5 = E_HhHh5(3); E_HhHh_hh5 = E_HhHh5(4); E_HhHh_hR5 = E_HhHh5(5); E_HhHh_RR5 = E_HhHh5(6);

    E_HhHR5 = mnrnd(poissrnd(beta_Hh*MHh_HR5(t-T0-TL-TP)),[((1+e)/4),((1-e-rho)/4),((1+e+rho)/4),((1-e-rho)/4),(rho/4)]);
    E_HhHR_HH5 = E_HhHR5(1); E_HhHR_Hh5 = E_HhHR5(2); E_HhHR_HR5 = E_HhHR5(3); E_HhHR_hR5 = E_HhHR5(4); E_HhHR_RR5 = E_HhHR5(5);

    E_Hhhh5 = mnrnd(poissrnd(beta_Hh*MHh_hh5(t-T0-TL-TP)),[((1+e)/2),((1-e-rho)/2),(rho/2)]);
    E_Hhhh_Hh5 = E_Hhhh5(1); E_Hhhh_hh5 = E_Hhhh5(2); E_Hhhh_hR5 = E_Hhhh5(3);

    E_HhhR5 = mnrnd(poissrnd(beta_Hh*MHh_hR5(t-T0-TL-TP)),[((1+e)/4),((1+e)/4),((1-e-rho)/4),((1-e)/4),(rho/4)]);
    E_HhhR_Hh5 = E_HhhR5(1); E_HhhR_HR5 = E_HhhR5(2); E_HhhR_hh5 = E_HhhR5(3); E_HhhR_hR5 = E_HhhR5(4); E_HhhR_RR5 = E_HhhR5(5);
    
    E_HhRR5 = mnrnd(poissrnd(beta_Hh*MHh_RR5(t-T0-TL-TP)),[((1+e)/2),((1-e-rho)/2),(rho/2)]);
    E_HhRR_HR5 = E_HhRR5(1); E_HhRR_hR5 = E_HhRR5(2); E_HhRR_RR5 = E_HhRR5(3);
    
    % Eggs produced by HR females:
    
    E_HRHH5 = mnrnd(poissrnd(beta_HR*MHR_HH5(t-T0-TL-TP)),[(1/2),(1/2)]);
    E_HRHH_HH5 = E_HRHH5(1); E_HRHH_HR5 = E_HRHH5(2);

    E_HRHh5 = mnrnd(poissrnd(beta_HR*MHR_Hh5(t-T0-TL-TP)),[((1+e)/4),((1-e-rho)/4),((1+e+rho)/4),((1-e-rho)/4),(rho/4)]);
    E_HRHh_HH5 = E_HRHh5(1); E_HRHh_Hh5 = E_HRHh5(2); E_HRHh_HR5 = E_HRHh5(3); E_HRHh_hR5 = E_HRHh5(4); E_HRHh_RR5 = E_HRHh5(5);

    E_HRHR5 = mnrnd(poissrnd(beta_HR*MHR_HR5(t-T0-TL-TP)),[(1/4),(1/2),(1/4)]);
    E_HRHR_HH5 = E_HRHR5(1); E_HRHR_HR5 = E_HRHR5(2); E_HRHR_RR5 = E_HRHR5(3);

    E_HRhh5 = mnrnd(poissrnd(beta_HR*MHR_hh5(t-T0-TL-TP)),[(1/2),(1/2)]);
    E_HRhh_Hh5 = E_HRhh5(1); E_HRhh_hR5 = E_HRhh5(2);

    E_HRhR5 = mnrnd(poissrnd(beta_HR*MHR_hR5(t-T0-TL-TP)),[(1/4),(1/4),(1/4),(1/4)]);
    E_HRhR_Hh5 = E_HRhR5(1); E_HRhR_HR5 = E_HRhR5(2); E_HRhR_hR5 = E_HRhR5(3); E_HRhR_RR5 = E_HRhR5(4);
    
    E_HRRR5 = mnrnd(poissrnd(beta_HR*MHR_RR5(t-T0-TL-TP)),[(1/2),(1/2)]);
    E_HRRR_HR5 = E_HRRR5(1); E_HRRR_RR5 = E_HRRR5(2);
    ...
    E_hRHh5 = mnrnd(poissrnd(beta_hR*MhR_Hh5(t-T0-TL-TP)),[((1+e)/4),((1+e)/4),((1-e-rho)/4),((1-e)/4),(rho/4)]);
    E_hRHh_Hh5 = E_hRHh5(1); E_hRHh_HR5 = E_hRHh5(2); E_hRHh_hh5 = E_hRHh5(3); E_hRHh_hR5 = E_hRHh5(4); E_hRHh_RR5 = E_hRHh5(5);
    ...
    E_RRHH5 = poissrnd(beta_RR*MRR_HH5(t-T0-TL-TP));
    E_RRHH_HR5 = E_RRHH5;

    E_RRHh5 = mnrnd(poissrnd(beta_RR*MRR_Hh5(t-T0-TL-TP)),[((1+e)/2),((1-e-rho)/2),(rho/2)]);
    E_RRHh_HR5 = E_RRHh5(1); E_RRHh_hR5 = E_RRHh5(2); E_RRHh_RR5 = E_RRHh5(3);

    E_RRHR5 = mnrnd(poissrnd(beta_RR*MRR_HR5(t-T0-TL-TP)),[(1/2),(1/2)]);
    E_RRHR_HR5 = E_RRHR5(1); E_RRHR_RR5 = E_RRHR5(2);
    ...
    E_RRRR5 = poissrnd(beta_RR*MRR_RR5(t-T0-TL-TP));
    E_RRRR_RR5 = E_RRRR5;
    
    % Adult male & female newborns:
    
    MHH_Births5 = mnrnd(binornd((E_HHHH_HH5 + E_HHHh_HH5 + E_HHHR_HH5 + E_HhHH_HH5 + E_HhHh_HH5 + E_HhHR_HH5 + E_HRHH_HH5 + E_HRHh_HH5 + E_HRHR_HH5),theta0*thetaLA*thetaP*(1-mu_m_HH)),[(1/2),(1/2)]);
    MHh_Births5 = mnrnd(binornd((E_HHHh_Hh5 + E_HHhh_Hh5 + E_HHhR_Hh5 + E_HhHH_Hh5 + E_HhHh_Hh5 + E_HhHR_Hh5 + E_Hhhh_Hh5 + E_HhhR_Hh5 + E_HRHh_Hh5 + E_HRhh_Hh5 + E_HRhR_Hh5 + E_hhHH_Hh5 + E_hhHh_Hh5 + E_hhHR_Hh5 + E_hRHH_Hh5 + E_hRHh_Hh5 + E_hRHR_Hh5),theta0*thetaLA*thetaP*(1-mu_m_Hh)),[(1/2),(1/2)]);
    MHR_Births5 = mnrnd(binornd((E_HHHh_HR5 + E_HHHR_HR5 + E_HHhR_HR5 + E_HHRR_HR5 + E_HhHH_HR5 + E_HhHh_HR5 + E_HhHR_HR5 + E_HhhR_HR5 + E_HhRR_HR5 + E_HRHH_HR5 + E_HRHh_HR5 + E_HRHR_HR5 + E_HRhR_HR5 + E_HRRR_HR5 + E_hRHH_HR5 + E_hRHh_HR5 + E_hRHR_HR5 + E_RRHH_HR5 + E_RRHh_HR5 + E_RRHR_HR5),theta0*thetaLA*thetaP*(1-mu_m_HR)),[(1/2),(1/2)]);
    Mhh_Births5 = mnrnd(binornd((E_HhHh_hh5 + E_Hhhh_hh5 + E_HhhR_hh5 + E_hhHh_hh5 + E_hhhh_hh5 + E_hhhR_hh5 + E_hRHh_hh5 + E_hRhh_hh5 + E_hRhR_hh5),theta0*thetaLA*thetaP*(1-mu_m_hh)),[(1/2),(1/2)]);
    MhR_Births5 = mnrnd(binornd((E_HhHh_hR5 + E_HhHR_hR5 + E_Hhhh_hR5 + E_HhhR_hR5 + E_HhRR_hR5 + E_HRHh_hR5 + E_HRhh_hR5 + E_HRhR_hR5 + E_hhHh_hR5 + E_hhHR_hR5 + E_hhhR_hR5 + E_hhRR_hR5 + E_hRHh_hR5 + E_hRHR_hR5 + E_hRhh_hR5 + E_hRhR_hR5 + E_hRRR_hR5 + E_RRHh_hR5 + E_RRhh_hR5 + E_RRhR_hR5),theta0*thetaLA*thetaP*(1-mu_m_hR)),[(1/2),(1/2)]);
    MRR_Births5 = mnrnd(binornd((E_HhHh_RR5 + E_HhHR_RR5 + E_HhhR_RR5 + E_HhRR_RR5 + E_HRHh_RR5 + E_HRHR_RR5 + E_HRhR_RR5 + E_HRRR_RR5 + E_hRHh_RR5 + E_hRHR_RR5 + E_hRhR_RR5 + E_hRRR_RR5 + E_RRHh_RR5 + E_RRHR_RR5 + E_RRhR_RR5 + E_RRRR_RR5),theta0*thetaLA*thetaP*(1-mu_m_RR)),[(1/2),(1/2)]);

    % Adult male genotypes:
    
    MHH5(t) = max(0,binornd(MHH5(t-1),(1-mu_m_HH)) + MHH_Births5(1));
    MHh5(t) = max(0,binornd(MHh5(t-1),(1-mu_m_Hh)) + MHh_Births5(1));
    MHR5(t) = max(0,binornd(MHR5(t-1),(1-mu_m_HR)) + MHR_Births5(1));
    Mhh5(t) = max(0,binornd(Mhh5(t-1),(1-mu_m_hh)) + Mhh_Births5(1));
    MhR5(t) = max(0,binornd(MhR5(t-1),(1-mu_m_hR)) + MhR_Births5(1));
    MRR5(t) = max(0,binornd(MRR5(t-1),(1-mu_m_RR)) + MRR_Births5(1));
    
    % Adult female genotypes:
    
    X_HH5 = mnrnd(MHH_Births5(2) , [ (MHH5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (Mhh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MhR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MRR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) ]);
    X_Hh5 = mnrnd(MHh_Births5(2) , [ (MHH5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (Mhh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MhR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MRR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) ]);
    X_HR5 = mnrnd(MHR_Births5(2) , [ (MHH5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (Mhh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MhR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MRR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) ]);
    X_hh5 = mnrnd(Mhh_Births5(2) , [ (MHH5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (Mhh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MhR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MRR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) ]);
    X_hR5 = mnrnd(MhR_Births5(2) , [ (MHH5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (Mhh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MhR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MRR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) ]);    
    X_RR5 = mnrnd(MRR_Births5(2) , [ (MHH5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MHR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (Mhh5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MhR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) , (MRR5(t-1)/(MHH5(t-1)+MHh5(t-1)+MHR5(t-1)+Mhh5(t-1)+MhR5(t-1)+MRR5(t-1))) ]);

    MHH5_Temp = [binornd(MHH_HH5(t-1),(1-mu_m_HH)) , binornd(MHH_Hh5(t-1),(1-mu_m_HH)) , binornd(MHH_HR5(t-1),(1-mu_m_HH)) , binornd(MHH_hh5(t-1),(1-mu_m_HH)) , binornd(MHH_hR5(t-1),(1-mu_m_HH)) , binornd(MHH_RR5(t-1),(1-mu_m_HH))] + X_HH5;
    MHH_HH5(t) = MHH5_Temp(1); MHH_Hh5(t) = MHH5_Temp(2); MHH_HR5(t) = MHH5_Temp(3); MHH_hh5(t) = MHH5_Temp(4); MHH_hR5(t) = MHH5_Temp(5); MHH_RR5(t) = MHH5_Temp(6);

    MHh5_Temp = [binornd(MHh_HH5(t-1),(1-mu_m_Hh)) , binornd(MHh_Hh5(t-1),(1-mu_m_Hh)) , binornd(MHh_HR5(t-1),(1-mu_m_Hh)) , binornd(MHh_hh5(t-1),(1-mu_m_Hh)) , binornd(MHh_hR5(t-1),(1-mu_m_Hh)) , binornd(MHh_RR5(t-1),(1-mu_m_Hh))] + X_Hh5;
    MHh_HH5(t) = MHh5_Temp(1); MHh_Hh5(t) = MHh5_Temp(2); MHh_HR5(t) = MHh5_Temp(3); MHh_hh5(t) = MHh5_Temp(4); MHh_hR5(t) = MHh5_Temp(5); MHh_RR5(t) = MHh5_Temp(6);

    MHR5_Temp = [binornd(MHR_HH5(t-1),(1-mu_m_HR)) , binornd(MHR_Hh5(t-1),(1-mu_m_HR)) , binornd(MHR_HR5(t-1),(1-mu_m_HR)) , binornd(MHR_hh5(t-1),(1-mu_m_HR)) , binornd(MHR_hR5(t-1),(1-mu_m_HR)) , binornd(MHR_RR5(t-1),(1-mu_m_HR))] + X_HR5;
    MHR_HH5(t) = MHR5_Temp(1); MHR_Hh5(t) = MHR5_Temp(2); MHR_HR5(t) = MHR5_Temp(3); MHR_hh5(t) = MHR5_Temp(4); MHR_hR5(t) = MHR5_Temp(5); MHR_RR5(t) = MHR5_Temp(6);
    ...
    MRR5_Temp = [binornd(MRR_HH5(t-1),(1-mu_m_RR)) , binornd(MRR_Hh5(t-1),(1-mu_m_RR)) , binornd(MRR_HR5(t-1),(1-mu_m_RR)) , binornd(MRR_hh5(t-1),(1-mu_m_RR)) , binornd(MRR_hR5(t-1),(1-mu_m_RR)) , binornd(MRR_RR5(t-1),(1-mu_m_RR))] + X_RR5;
    MRR_HH5(t) = MRR5_Temp(1); MRR_Hh5(t) = MRR5_Temp(2); MRR_HR5(t) = MRR5_Temp(3); MRR_hh5(t) = MRR5_Temp(4); MRR_hR5(t) = MRR5_Temp(5); MRR_RR5(t) = MRR5_Temp(6);
    
    MHH_HH5(t) = max(0,MHH_HH5(t)); MHH_Hh5(t) = max(0,MHH_Hh5(t)); MHH_HR5(t) = max(0,MHH_HR5(t)); MHH_hh5(t) = max(0,MHH_hh5(t)); MHH_hR5(t) = max(0,MHH_hR5(t)); MHH_RR5(t) = max(0,MHH_RR5(t));
    MHh_HH5(t) = max(0,MHh_HH5(t)); MHh_Hh5(t) = max(0,MHh_Hh5(t)); MHh_HR5(t) = max(0,MHh_HR5(t)); MHh_hh5(t) = max(0,MHh_hh5(t)); MHh_hR5(t) = max(0,MHh_hR5(t)); MHh_RR5(t) = max(0,MHh_RR5(t));
    MHR_HH5(t) = max(0,MHR_HH5(t)); MHR_Hh5(t) = max(0,MHR_Hh5(t)); MHR_HR5(t) = max(0,MHR_HR5(t)); MHR_hh5(t) = max(0,MHR_hh5(t)); MHR_hR5(t) = max(0,MHR_hR5(t)); MHR_RR5(t) = max(0,MHR_RR5(t));
    Mhh_HH5(t) = max(0,Mhh_HH5(t)); Mhh_Hh5(t) = max(0,Mhh_Hh5(t)); Mhh_HR5(t) = max(0,Mhh_HR5(t)); Mhh_hh5(t) = max(0,Mhh_hh5(t)); Mhh_hR5(t) = max(0,Mhh_hR5(t)); Mhh_RR5(t) = max(0,Mhh_RR5(t));
    MhR_HH5(t) = max(0,MhR_HH5(t)); MhR_Hh5(t) = max(0,MhR_Hh5(t)); MhR_HR5(t) = max(0,MhR_HR5(t)); MhR_hh5(t) = max(0,MhR_hh5(t)); MhR_hR5(t) = max(0,MhR_hR5(t)); MhR_RR5(t) = max(0,MhR_RR5(t));
    MRR_HH5(t) = max(0,MRR_HH5(t)); MRR_Hh5(t) = max(0,MRR_Hh5(t)); MRR_HR5(t) = max(0,MRR_HR5(t)); MRR_hh5(t) = max(0,MRR_hh5(t)); MRR_hR5(t) = max(0,MRR_hR5(t)); MRR_RR5(t) = max(0,MRR_RR5(t));

    if (t==51)
        MHH5(t) = MHH5(t) + M_eq;
        % MHH_HH5(t) = MHH_HH(t) + M_eq/2;
    end

    % Migrants pop 1 -> pop 2:
    MHH1to2(t) = poissrnd(MHH1(t)*migrate/4);
    MHh1to2(t) = poissrnd(MHh1(t)*migrate/4);
    MHR1to2(t) = poissrnd(MHR1(t)*migrate/4);
    Mhh1to2(t) = poissrnd(Mhh1(t)*migrate/4);
    MhR1to2(t) = poissrnd(MhR1(t)*migrate/4);
    MRR1to2(t) = poissrnd(MRR1(t)*migrate/4);

    MHH_HH1to2(t) = poissrnd(MHH_HH1(t)*migrate/4);
    MHH_Hh1to2(t) = poissrnd(MHH_Hh1(t)*migrate/4);
    MHH_HR1to2(t) = poissrnd(MHH_HR1(t)*migrate/4);
    MHH_hh1to2(t) = poissrnd(MHH_hh1(t)*migrate/4);
    MHH_hR1to2(t) = poissrnd(MHH_hR1(t)*migrate/4);
    MHH_RR1to2(t) = poissrnd(MHH_RR1(t)*migrate/4);
    ...
    MHR_HH1to2(t) = poissrnd(MHR_HH1(t)*migrate/4);
    MHR_Hh1to2(t) = poissrnd(MHR_Hh1(t)*migrate/4);
    MHR_HR1to2(t) = poissrnd(MHR_HR1(t)*migrate/4);
    MHR_hh1to2(t) = poissrnd(MHR_hh1(t)*migrate/4);
    MHR_hR1to2(t) = poissrnd(MHR_hR1(t)*migrate/4);
    MHR_RR1to2(t) = poissrnd(MHR_RR1(t)*migrate/4);
    ...
    MRR_HH1to2(t) = poissrnd(MRR_HH1(t)*migrate/4);
    MRR_Hh1to2(t) = poissrnd(MRR_Hh1(t)*migrate/4);
    MRR_HR1to2(t) = poissrnd(MRR_HR1(t)*migrate/4);
    MRR_hh1to2(t) = poissrnd(MRR_hh1(t)*migrate/4);
    MRR_hR1to2(t) = poissrnd(MRR_hR1(t)*migrate/4);
    MRR_RR1to2(t) = poissrnd(MRR_RR1(t)*migrate/4);

    % Migrants pop 1 -> pop 3:
    MHH1to3(t) = poissrnd(MHH1(t)*migrate/4);
    MHh1to3(t) = poissrnd(MHh1(t)*migrate/4);
    MHR1to3(t) = poissrnd(MHR1(t)*migrate/4);
    Mhh1to3(t) = poissrnd(Mhh1(t)*migrate/4);
    MhR1to3(t) = poissrnd(MhR1(t)*migrate/4);
    MRR1to3(t) = poissrnd(MRR1(t)*migrate/4);

    MHH_HH1to3(t) = poissrnd(MHH_HH1(t)*migrate/4);
    MHH_Hh1to3(t) = poissrnd(MHH_Hh1(t)*migrate/4);
    MHH_HR1to3(t) = poissrnd(MHH_HR1(t)*migrate/4);
    MHH_hh1to3(t) = poissrnd(MHH_hh1(t)*migrate/4);
    MHH_hR1to3(t) = poissrnd(MHH_hR1(t)*migrate/4);
    MHH_RR1to3(t) = poissrnd(MHH_RR1(t)*migrate/4);
    ...
    MHR_HH1to3(t) = poissrnd(MHR_HH1(t)*migrate/4);
    MHR_Hh1to3(t) = poissrnd(MHR_Hh1(t)*migrate/4);
    MHR_HR1to3(t) = poissrnd(MHR_HR1(t)*migrate/4);
    MHR_hh1to3(t) = poissrnd(MHR_hh1(t)*migrate/4);
    MHR_hR1to3(t) = poissrnd(MHR_hR1(t)*migrate/4);
    MHR_RR1to3(t) = poissrnd(MHR_RR1(t)*migrate/4);
    ...
    MRR_HH1to3(t) = poissrnd(MRR_HH1(t)*migrate/4);
    MRR_Hh1to3(t) = poissrnd(MRR_Hh1(t)*migrate/4);
    MRR_HR1to3(t) = poissrnd(MRR_HR1(t)*migrate/4);
    MRR_hh1to3(t) = poissrnd(MRR_hh1(t)*migrate/4);
    MRR_hR1to3(t) = poissrnd(MRR_hR1(t)*migrate/4);
    MRR_RR1to3(t) = poissrnd(MRR_RR1(t)*migrate/4);

    % Migrants pop 1 -> pop 4:
    MHH1to4(t) = poissrnd(MHH1(t)*migrate/4);
    MHh1to4(t) = poissrnd(MHh1(t)*migrate/4);
    MHR1to4(t) = poissrnd(MHR1(t)*migrate/4);
    Mhh1to4(t) = poissrnd(Mhh1(t)*migrate/4);
    MhR1to4(t) = poissrnd(MhR1(t)*migrate/4);
    MRR1to4(t) = poissrnd(MRR1(t)*migrate/4);

    MHH_HH1to4(t) = poissrnd(MHH_HH1(t)*migrate/4);
    MHH_Hh1to4(t) = poissrnd(MHH_Hh1(t)*migrate/4);
    MHH_HR1to4(t) = poissrnd(MHH_HR1(t)*migrate/4);
    MHH_hh1to4(t) = poissrnd(MHH_hh1(t)*migrate/4);
    MHH_hR1to4(t) = poissrnd(MHH_hR1(t)*migrate/4);
    MHH_RR1to4(t) = poissrnd(MHH_RR1(t)*migrate/4);
    ...
    MHR_HH1to4(t) = poissrnd(MHR_HH1(t)*migrate/4);
    MHR_Hh1to4(t) = poissrnd(MHR_Hh1(t)*migrate/4);
    MHR_HR1to4(t) = poissrnd(MHR_HR1(t)*migrate/4);
    MHR_hh1to4(t) = poissrnd(MHR_hh1(t)*migrate/4);
    MHR_hR1to4(t) = poissrnd(MHR_hR1(t)*migrate/4);
    MHR_RR1to4(t) = poissrnd(MHR_RR1(t)*migrate/4);
    ...
    MRR_HH1to4(t) = poissrnd(MRR_HH1(t)*migrate/4);
    MRR_Hh1to4(t) = poissrnd(MRR_Hh1(t)*migrate/4);
    MRR_HR1to4(t) = poissrnd(MRR_HR1(t)*migrate/4);
    MRR_hh1to4(t) = poissrnd(MRR_hh1(t)*migrate/4);
    MRR_hR1to4(t) = poissrnd(MRR_hR1(t)*migrate/4);
    MRR_RR1to4(t) = poissrnd(MRR_RR1(t)*migrate/4);

    % Migrants pop 1 -> pop 5:
    MHH1to5(t) = poissrnd(MHH1(t)*migrate/4);
    MHh1to5(t) = poissrnd(MHh1(t)*migrate/4);
    MHR1to5(t) = poissrnd(MHR1(t)*migrate/4);
    Mhh1to5(t) = poissrnd(Mhh1(t)*migrate/4);
    MhR1to5(t) = poissrnd(MhR1(t)*migrate/4);
    MRR1to5(t) = poissrnd(MRR1(t)*migrate/4);

    MHH_HH1to5(t) = poissrnd(MHH_HH1(t)*migrate/4);
    MHH_Hh1to5(t) = poissrnd(MHH_Hh1(t)*migrate/4);
    MHH_HR1to5(t) = poissrnd(MHH_HR1(t)*migrate/4);
    MHH_hh1to5(t) = poissrnd(MHH_hh1(t)*migrate/4);
    MHH_hR1to5(t) = poissrnd(MHH_hR1(t)*migrate/4);
    MHH_RR1to5(t) = poissrnd(MHH_RR1(t)*migrate/4);
    ...
    MHR_HH1to5(t) = poissrnd(MHR_HH1(t)*migrate/4);
    MHR_Hh1to5(t) = poissrnd(MHR_Hh1(t)*migrate/4);
    MHR_HR1to5(t) = poissrnd(MHR_HR1(t)*migrate/4);
    MHR_hh1to5(t) = poissrnd(MHR_hh1(t)*migrate/4);
    MHR_hR1to5(t) = poissrnd(MHR_hR1(t)*migrate/4);
    MHR_RR1to5(t) = poissrnd(MHR_RR1(t)*migrate/4);
    ...
    MRR_HH1to5(t) = poissrnd(MRR_HH1(t)*migrate/4);
    MRR_Hh1to5(t) = poissrnd(MRR_Hh1(t)*migrate/4);
    MRR_HR1to5(t) = poissrnd(MRR_HR1(t)*migrate/4);
    MRR_hh1to5(t) = poissrnd(MRR_hh1(t)*migrate/4);
    MRR_hR1to5(t) = poissrnd(MRR_hR1(t)*migrate/4);
    MRR_RR1to5(t) = poissrnd(MRR_RR1(t)*migrate/4);

    % Migrants pop 2 -> pop 1:
    MHH2to1(t) = poissrnd(MHH2(t)*migrate/4);
    MHh2to1(t) = poissrnd(MHh2(t)*migrate/4);
    MHR2to1(t) = poissrnd(MHR2(t)*migrate/4);
    Mhh2to1(t) = poissrnd(Mhh2(t)*migrate/4);
    MhR2to1(t) = poissrnd(MhR2(t)*migrate/4);
    MRR2to1(t) = poissrnd(MRR2(t)*migrate/4);

    MHH_HH2to1(t) = poissrnd(MHH_HH2(t)*migrate/4);
    MHH_Hh2to1(t) = poissrnd(MHH_Hh2(t)*migrate/4);
    MHH_HR2to1(t) = poissrnd(MHH_HR2(t)*migrate/4);
    MHH_hh2to1(t) = poissrnd(MHH_hh2(t)*migrate/4);
    MHH_hR2to1(t) = poissrnd(MHH_hR2(t)*migrate/4);
    MHH_RR2to1(t) = poissrnd(MHH_RR2(t)*migrate/4);
    ...
    MHR_HH2to1(t) = poissrnd(MHR_HH2(t)*migrate/4);
    MHR_Hh2to1(t) = poissrnd(MHR_Hh2(t)*migrate/4);
    MHR_HR2to1(t) = poissrnd(MHR_HR2(t)*migrate/4);
    MHR_hh2to1(t) = poissrnd(MHR_hh2(t)*migrate/4);
    MHR_hR2to1(t) = poissrnd(MHR_hR2(t)*migrate/4);
    MHR_RR2to1(t) = poissrnd(MHR_RR2(t)*migrate/4);
    ...
    MRR_HH2to1(t) = poissrnd(MRR_HH2(t)*migrate/4);
    MRR_Hh2to1(t) = poissrnd(MRR_Hh2(t)*migrate/4);
    MRR_HR2to1(t) = poissrnd(MRR_HR2(t)*migrate/4);
    MRR_hh2to1(t) = poissrnd(MRR_hh2(t)*migrate/4);
    MRR_hR2to1(t) = poissrnd(MRR_hR2(t)*migrate/4);
    MRR_RR2to1(t) = poissrnd(MRR_RR2(t)*migrate/4);

    % Migrants pop 2 -> pop 3:
    MHH2to3(t) = poissrnd(MHH2(t)*migrate/4);
    MHh2to3(t) = poissrnd(MHh2(t)*migrate/4);
    MHR2to3(t) = poissrnd(MHR2(t)*migrate/4);
    Mhh2to3(t) = poissrnd(Mhh2(t)*migrate/4);
    MhR2to3(t) = poissrnd(MhR2(t)*migrate/4);
    MRR2to3(t) = poissrnd(MRR2(t)*migrate/4);

    MHH_HH2to3(t) = poissrnd(MHH_HH2(t)*migrate/4);
    MHH_Hh2to3(t) = poissrnd(MHH_Hh2(t)*migrate/4);
    MHH_HR2to3(t) = poissrnd(MHH_HR2(t)*migrate/4);
    MHH_hh2to3(t) = poissrnd(MHH_hh2(t)*migrate/4);
    MHH_hR2to3(t) = poissrnd(MHH_hR2(t)*migrate/4);
    MHH_RR2to3(t) = poissrnd(MHH_RR2(t)*migrate/4);
    ...
    MHR_HH2to3(t) = poissrnd(MHR_HH2(t)*migrate/4);
    MHR_Hh2to3(t) = poissrnd(MHR_Hh2(t)*migrate/4);
    MHR_HR2to3(t) = poissrnd(MHR_HR2(t)*migrate/4);
    MHR_hh2to3(t) = poissrnd(MHR_hh2(t)*migrate/4);
    MHR_hR2to3(t) = poissrnd(MHR_hR2(t)*migrate/4);
    MHR_RR2to3(t) = poissrnd(MHR_RR2(t)*migrate/4);
    ...
    MRR_HH2to3(t) = poissrnd(MRR_HH2(t)*migrate/4);
    MRR_Hh2to3(t) = poissrnd(MRR_Hh2(t)*migrate/4);
    MRR_HR2to3(t) = poissrnd(MRR_HR2(t)*migrate/4);
    MRR_hh2to3(t) = poissrnd(MRR_hh2(t)*migrate/4);
    MRR_hR2to3(t) = poissrnd(MRR_hR2(t)*migrate/4);
    MRR_RR2to3(t) = poissrnd(MRR_RR2(t)*migrate/4);

    % Migrants pop 2 -> pop 4:
    MHH2to4(t) = poissrnd(MHH2(t)*migrate/4);
    MHh2to4(t) = poissrnd(MHh2(t)*migrate/4);
    MHR2to4(t) = poissrnd(MHR2(t)*migrate/4);
    Mhh2to4(t) = poissrnd(Mhh2(t)*migrate/4);
    MhR2to4(t) = poissrnd(MhR2(t)*migrate/4);
    MRR2to4(t) = poissrnd(MRR2(t)*migrate/4);

    MHH_HH2to4(t) = poissrnd(MHH_HH2(t)*migrate/4);
    MHH_Hh2to4(t) = poissrnd(MHH_Hh2(t)*migrate/4);
    MHH_HR2to4(t) = poissrnd(MHH_HR2(t)*migrate/4);
    MHH_hh2to4(t) = poissrnd(MHH_hh2(t)*migrate/4);
    MHH_hR2to4(t) = poissrnd(MHH_hR2(t)*migrate/4);
    MHH_RR2to4(t) = poissrnd(MHH_RR2(t)*migrate/4);
    ...
    MHR_HH2to4(t) = poissrnd(MHR_HH2(t)*migrate/4);
    MHR_Hh2to4(t) = poissrnd(MHR_Hh2(t)*migrate/4);
    MHR_HR2to4(t) = poissrnd(MHR_HR2(t)*migrate/4);
    MHR_hh2to4(t) = poissrnd(MHR_hh2(t)*migrate/4);
    MHR_hR2to4(t) = poissrnd(MHR_hR2(t)*migrate/4);
    MHR_RR2to4(t) = poissrnd(MHR_RR2(t)*migrate/4);
    ...
    MRR_HH2to4(t) = poissrnd(MRR_HH2(t)*migrate/4);
    MRR_Hh2to4(t) = poissrnd(MRR_Hh2(t)*migrate/4);
    MRR_HR2to4(t) = poissrnd(MRR_HR2(t)*migrate/4);
    MRR_hh2to4(t) = poissrnd(MRR_hh2(t)*migrate/4);
    MRR_hR2to4(t) = poissrnd(MRR_hR2(t)*migrate/4);
    MRR_RR2to4(t) = poissrnd(MRR_RR2(t)*migrate/4);

    % Migrants pop 2 -> pop 5:
    MHH2to5(t) = poissrnd(MHH2(t)*migrate/4);
    MHh2to5(t) = poissrnd(MHh2(t)*migrate/4);
    MHR2to5(t) = poissrnd(MHR2(t)*migrate/4);
    Mhh2to5(t) = poissrnd(Mhh2(t)*migrate/4);
    MhR2to5(t) = poissrnd(MhR2(t)*migrate/4);
    MRR2to5(t) = poissrnd(MRR2(t)*migrate/4);

    MHH_HH2to5(t) = poissrnd(MHH_HH2(t)*migrate/4);
    MHH_Hh2to5(t) = poissrnd(MHH_Hh2(t)*migrate/4);
    MHH_HR2to5(t) = poissrnd(MHH_HR2(t)*migrate/4);
    MHH_hh2to5(t) = poissrnd(MHH_hh2(t)*migrate/4);
    MHH_hR2to5(t) = poissrnd(MHH_hR2(t)*migrate/4);
    MHH_RR2to5(t) = poissrnd(MHH_RR2(t)*migrate/4);
    ...
    MHR_HH2to5(t) = poissrnd(MHR_HH2(t)*migrate/4);
    MHR_Hh2to5(t) = poissrnd(MHR_Hh2(t)*migrate/4);
    MHR_HR2to5(t) = poissrnd(MHR_HR2(t)*migrate/4);
    MHR_hh2to5(t) = poissrnd(MHR_hh2(t)*migrate/4);
    MHR_hR2to5(t) = poissrnd(MHR_hR2(t)*migrate/4);
    MHR_RR2to5(t) = poissrnd(MHR_RR2(t)*migrate/4);
    ...
    MRR_HH2to5(t) = poissrnd(MRR_HH2(t)*migrate/4);
    MRR_Hh2to5(t) = poissrnd(MRR_Hh2(t)*migrate/4);
    MRR_HR2to5(t) = poissrnd(MRR_HR2(t)*migrate/4);
    MRR_hh2to5(t) = poissrnd(MRR_hh2(t)*migrate/4);
    MRR_hR2to5(t) = poissrnd(MRR_hR2(t)*migrate/4);
    MRR_RR2to5(t) = poissrnd(MRR_RR2(t)*migrate/4);

    % Migrants pop 3 -> pop 1:
    MHH3to1(t) = poissrnd(MHH3(t)*migrate/4);
    MHh3to1(t) = poissrnd(MHh3(t)*migrate/4);
    MHR3to1(t) = poissrnd(MHR3(t)*migrate/4);
    Mhh3to1(t) = poissrnd(Mhh3(t)*migrate/4);
    MhR3to1(t) = poissrnd(MhR3(t)*migrate/4);
    MRR3to1(t) = poissrnd(MRR3(t)*migrate/4);

    MHH_HH3to1(t) = poissrnd(MHH_HH3(t)*migrate/4);
    MHH_Hh3to1(t) = poissrnd(MHH_Hh3(t)*migrate/4);
    MHH_HR3to1(t) = poissrnd(MHH_HR3(t)*migrate/4);
    MHH_hh3to1(t) = poissrnd(MHH_hh3(t)*migrate/4);
    MHH_hR3to1(t) = poissrnd(MHH_hR3(t)*migrate/4);
    MHH_RR3to1(t) = poissrnd(MHH_RR3(t)*migrate/4);
    ...
    MHR_HH3to1(t) = poissrnd(MHR_HH3(t)*migrate/4);
    MHR_Hh3to1(t) = poissrnd(MHR_Hh3(t)*migrate/4);
    MHR_HR3to1(t) = poissrnd(MHR_HR3(t)*migrate/4);
    MHR_hh3to1(t) = poissrnd(MHR_hh3(t)*migrate/4);
    MHR_hR3to1(t) = poissrnd(MHR_hR3(t)*migrate/4);
    MHR_RR3to1(t) = poissrnd(MHR_RR3(t)*migrate/4);
    ...
    MRR_HH3to1(t) = poissrnd(MRR_HH3(t)*migrate/4);
    MRR_Hh3to1(t) = poissrnd(MRR_Hh3(t)*migrate/4);
    MRR_HR3to1(t) = poissrnd(MRR_HR3(t)*migrate/4);
    MRR_hh3to1(t) = poissrnd(MRR_hh3(t)*migrate/4);
    MRR_hR3to1(t) = poissrnd(MRR_hR3(t)*migrate/4);
    MRR_RR3to1(t) = poissrnd(MRR_RR3(t)*migrate/4);

    % Migrants pop 3 -> pop 2:
    MHH3to2(t) = poissrnd(MHH3(t)*migrate/4);
    MHh3to2(t) = poissrnd(MHh3(t)*migrate/4);
    MHR3to2(t) = poissrnd(MHR3(t)*migrate/4);
    Mhh3to2(t) = poissrnd(Mhh3(t)*migrate/4);
    MhR3to2(t) = poissrnd(MhR3(t)*migrate/4);
    MRR3to2(t) = poissrnd(MRR3(t)*migrate/4);

    MHH_HH3to2(t) = poissrnd(MHH_HH3(t)*migrate/4);
    MHH_Hh3to2(t) = poissrnd(MHH_Hh3(t)*migrate/4);
    MHH_HR3to2(t) = poissrnd(MHH_HR3(t)*migrate/4);
    MHH_hh3to2(t) = poissrnd(MHH_hh3(t)*migrate/4);
    MHH_hR3to2(t) = poissrnd(MHH_hR3(t)*migrate/4);
    MHH_RR3to2(t) = poissrnd(MHH_RR3(t)*migrate/4);
    ...
    MHR_HH3to2(t) = poissrnd(MHR_HH3(t)*migrate/4);
    MHR_Hh3to2(t) = poissrnd(MHR_Hh3(t)*migrate/4);
    MHR_HR3to2(t) = poissrnd(MHR_HR3(t)*migrate/4);
    MHR_hh3to2(t) = poissrnd(MHR_hh3(t)*migrate/4);
    MHR_hR3to2(t) = poissrnd(MHR_hR3(t)*migrate/4);
    MHR_RR3to2(t) = poissrnd(MHR_RR3(t)*migrate/4);
    ...
    MRR_HH3to2(t) = poissrnd(MRR_HH3(t)*migrate/4);
    MRR_Hh3to2(t) = poissrnd(MRR_Hh3(t)*migrate/4);
    MRR_HR3to2(t) = poissrnd(MRR_HR3(t)*migrate/4);
    MRR_hh3to2(t) = poissrnd(MRR_hh3(t)*migrate/4);
    MRR_hR3to2(t) = poissrnd(MRR_hR3(t)*migrate/4);
    MRR_RR3to2(t) = poissrnd(MRR_RR3(t)*migrate/4);

    % Migrants pop 3 -> pop 4:
    MHH3to4(t) = poissrnd(MHH3(t)*migrate/4);
    MHh3to4(t) = poissrnd(MHh3(t)*migrate/4);
    MHR3to4(t) = poissrnd(MHR3(t)*migrate/4);
    Mhh3to4(t) = poissrnd(Mhh3(t)*migrate/4);
    MhR3to4(t) = poissrnd(MhR3(t)*migrate/4);
    MRR3to4(t) = poissrnd(MRR3(t)*migrate/4);

    MHH_HH3to4(t) = poissrnd(MHH_HH3(t)*migrate/4);
    MHH_Hh3to4(t) = poissrnd(MHH_Hh3(t)*migrate/4);
    MHH_HR3to4(t) = poissrnd(MHH_HR3(t)*migrate/4);
    MHH_hh3to4(t) = poissrnd(MHH_hh3(t)*migrate/4);
    MHH_hR3to4(t) = poissrnd(MHH_hR3(t)*migrate/4);
    MHH_RR3to4(t) = poissrnd(MHH_RR3(t)*migrate/4);
    ...
    MHR_HH3to4(t) = poissrnd(MHR_HH3(t)*migrate/4);
    MHR_Hh3to4(t) = poissrnd(MHR_Hh3(t)*migrate/4);
    MHR_HR3to4(t) = poissrnd(MHR_HR3(t)*migrate/4);
    MHR_hh3to4(t) = poissrnd(MHR_hh3(t)*migrate/4);
    MHR_hR3to4(t) = poissrnd(MHR_hR3(t)*migrate/4);
    MHR_RR3to4(t) = poissrnd(MHR_RR3(t)*migrate/4);
    ...
    MRR_HH3to4(t) = poissrnd(MRR_HH3(t)*migrate/4);
    MRR_Hh3to4(t) = poissrnd(MRR_Hh3(t)*migrate/4);
    MRR_HR3to4(t) = poissrnd(MRR_HR3(t)*migrate/4);
    MRR_hh3to4(t) = poissrnd(MRR_hh3(t)*migrate/4);
    MRR_hR3to4(t) = poissrnd(MRR_hR3(t)*migrate/4);
    MRR_RR3to4(t) = poissrnd(MRR_RR3(t)*migrate/4);

    % Migrants pop 3 -> pop 5:
    MHH3to5(t) = poissrnd(MHH3(t)*migrate/4);
    MHh3to5(t) = poissrnd(MHh3(t)*migrate/4);
    MHR3to5(t) = poissrnd(MHR3(t)*migrate/4);
    Mhh3to5(t) = poissrnd(Mhh3(t)*migrate/4);
    MhR3to5(t) = poissrnd(MhR3(t)*migrate/4);
    MRR3to5(t) = poissrnd(MRR3(t)*migrate/4);

    MHH_HH3to5(t) = poissrnd(MHH_HH3(t)*migrate/4);
    MHH_Hh3to5(t) = poissrnd(MHH_Hh3(t)*migrate/4);
    MHH_HR3to5(t) = poissrnd(MHH_HR3(t)*migrate/4);
    MHH_hh3to5(t) = poissrnd(MHH_hh3(t)*migrate/4);
    MHH_hR3to5(t) = poissrnd(MHH_hR3(t)*migrate/4);
    MHH_RR3to5(t) = poissrnd(MHH_RR3(t)*migrate/4);
    ...
    MHR_HH3to5(t) = poissrnd(MHR_HH3(t)*migrate/4);
    MHR_Hh3to5(t) = poissrnd(MHR_Hh3(t)*migrate/4);
    MHR_HR3to5(t) = poissrnd(MHR_HR3(t)*migrate/4);
    MHR_hh3to5(t) = poissrnd(MHR_hh3(t)*migrate/4);
    MHR_hR3to5(t) = poissrnd(MHR_hR3(t)*migrate/4);
    MHR_RR3to5(t) = poissrnd(MHR_RR3(t)*migrate/4);
    ...
    MRR_HH3to5(t) = poissrnd(MRR_HH3(t)*migrate/4);
    MRR_Hh3to5(t) = poissrnd(MRR_Hh3(t)*migrate/4);
    MRR_HR3to5(t) = poissrnd(MRR_HR3(t)*migrate/4);
    MRR_hh3to5(t) = poissrnd(MRR_hh3(t)*migrate/4);
    MRR_hR3to5(t) = poissrnd(MRR_hR3(t)*migrate/4);
    MRR_RR3to5(t) = poissrnd(MRR_RR3(t)*migrate/4);

    % Migrants pop 4 -> pop 1:
    MHH4to1(t) = poissrnd(MHH4(t)*migrate/4);
    MHh4to1(t) = poissrnd(MHh4(t)*migrate/4);
    MHR4to1(t) = poissrnd(MHR4(t)*migrate/4);
    Mhh4to1(t) = poissrnd(Mhh4(t)*migrate/4);
    MhR4to1(t) = poissrnd(MhR4(t)*migrate/4);
    MRR4to1(t) = poissrnd(MRR4(t)*migrate/4);

    MHH_HH4to1(t) = poissrnd(MHH_HH4(t)*migrate/4);
    MHH_Hh4to1(t) = poissrnd(MHH_Hh4(t)*migrate/4);
    MHH_HR4to1(t) = poissrnd(MHH_HR4(t)*migrate/4);
    MHH_hh4to1(t) = poissrnd(MHH_hh4(t)*migrate/4);
    MHH_hR4to1(t) = poissrnd(MHH_hR4(t)*migrate/4);
    MHH_RR4to1(t) = poissrnd(MHH_RR4(t)*migrate/4);
    ...
    MHR_HH4to1(t) = poissrnd(MHR_HH4(t)*migrate/4);
    MHR_Hh4to1(t) = poissrnd(MHR_Hh4(t)*migrate/4);
    MHR_HR4to1(t) = poissrnd(MHR_HR4(t)*migrate/4);
    MHR_hh4to1(t) = poissrnd(MHR_hh4(t)*migrate/4);
    MHR_hR4to1(t) = poissrnd(MHR_hR4(t)*migrate/4);
    MHR_RR4to1(t) = poissrnd(MHR_RR4(t)*migrate/4);
    ...
    MRR_HH4to1(t) = poissrnd(MRR_HH4(t)*migrate/4);
    MRR_Hh4to1(t) = poissrnd(MRR_Hh4(t)*migrate/4);
    MRR_HR4to1(t) = poissrnd(MRR_HR4(t)*migrate/4);
    MRR_hh4to1(t) = poissrnd(MRR_hh4(t)*migrate/4);
    MRR_hR4to1(t) = poissrnd(MRR_hR4(t)*migrate/4);
    MRR_RR4to1(t) = poissrnd(MRR_RR4(t)*migrate/4);

    % Migrants pop 4 -> pop 2:
    MHH4to2(t) = poissrnd(MHH4(t)*migrate/4);
    MHh4to2(t) = poissrnd(MHh4(t)*migrate/4);
    MHR4to2(t) = poissrnd(MHR4(t)*migrate/4);
    Mhh4to2(t) = poissrnd(Mhh4(t)*migrate/4);
    MhR4to2(t) = poissrnd(MhR4(t)*migrate/4);
    MRR4to2(t) = poissrnd(MRR4(t)*migrate/4);

    MHH_HH4to2(t) = poissrnd(MHH_HH4(t)*migrate/4);
    MHH_Hh4to2(t) = poissrnd(MHH_Hh4(t)*migrate/4);
    MHH_HR4to2(t) = poissrnd(MHH_HR4(t)*migrate/4);
    MHH_hh4to2(t) = poissrnd(MHH_hh4(t)*migrate/4);
    MHH_hR4to2(t) = poissrnd(MHH_hR4(t)*migrate/4);
    MHH_RR4to2(t) = poissrnd(MHH_RR4(t)*migrate/4);
    ...
    MHR_HH4to2(t) = poissrnd(MHR_HH4(t)*migrate/4);
    MHR_Hh4to2(t) = poissrnd(MHR_Hh4(t)*migrate/4);
    MHR_HR4to2(t) = poissrnd(MHR_HR4(t)*migrate/4);
    MHR_hh4to2(t) = poissrnd(MHR_hh4(t)*migrate/4);
    MHR_hR4to2(t) = poissrnd(MHR_hR4(t)*migrate/4);
    MHR_RR4to2(t) = poissrnd(MHR_RR4(t)*migrate/4);
    ...
    MRR_HH4to2(t) = poissrnd(MRR_HH4(t)*migrate/4);
    MRR_Hh4to2(t) = poissrnd(MRR_Hh4(t)*migrate/4);
    MRR_HR4to2(t) = poissrnd(MRR_HR4(t)*migrate/4);
    MRR_hh4to2(t) = poissrnd(MRR_hh4(t)*migrate/4);
    MRR_hR4to2(t) = poissrnd(MRR_hR4(t)*migrate/4);
    MRR_RR4to2(t) = poissrnd(MRR_RR4(t)*migrate/4);

    % Migrants pop 4 -> pop 3:
    MHH4to3(t) = poissrnd(MHH4(t)*migrate/4);
    MHh4to3(t) = poissrnd(MHh4(t)*migrate/4);
    MHR4to3(t) = poissrnd(MHR4(t)*migrate/4);
    Mhh4to3(t) = poissrnd(Mhh4(t)*migrate/4);
    MhR4to3(t) = poissrnd(MhR4(t)*migrate/4);
    MRR4to3(t) = poissrnd(MRR4(t)*migrate/4);

    MHH_HH4to3(t) = poissrnd(MHH_HH4(t)*migrate/4);
    MHH_Hh4to3(t) = poissrnd(MHH_Hh4(t)*migrate/4);
    MHH_HR4to3(t) = poissrnd(MHH_HR4(t)*migrate/4);
    MHH_hh4to3(t) = poissrnd(MHH_hh4(t)*migrate/4);
    MHH_hR4to3(t) = poissrnd(MHH_hR4(t)*migrate/4);
    MHH_RR4to3(t) = poissrnd(MHH_RR4(t)*migrate/4);
    ...
    MHR_HH4to3(t) = poissrnd(MHR_HH4(t)*migrate/4);
    MHR_Hh4to3(t) = poissrnd(MHR_Hh4(t)*migrate/4);
    MHR_HR4to3(t) = poissrnd(MHR_HR4(t)*migrate/4);
    MHR_hh4to3(t) = poissrnd(MHR_hh4(t)*migrate/4);
    MHR_hR4to3(t) = poissrnd(MHR_hR4(t)*migrate/4);
    MHR_RR4to3(t) = poissrnd(MHR_RR4(t)*migrate/4);
    ...
    MRR_HH4to3(t) = poissrnd(MRR_HH4(t)*migrate/4);
    MRR_Hh4to3(t) = poissrnd(MRR_Hh4(t)*migrate/4);
    MRR_HR4to3(t) = poissrnd(MRR_HR4(t)*migrate/4);
    MRR_hh4to3(t) = poissrnd(MRR_hh4(t)*migrate/4);
    MRR_hR4to3(t) = poissrnd(MRR_hR4(t)*migrate/4);
    MRR_RR4to3(t) = poissrnd(MRR_RR4(t)*migrate/4);

    % Migrants pop 4 -> pop 5:
    MHH4to5(t) = poissrnd(MHH4(t)*migrate/4);
    MHh4to5(t) = poissrnd(MHh4(t)*migrate/4);
    MHR4to5(t) = poissrnd(MHR4(t)*migrate/4);
    Mhh4to5(t) = poissrnd(Mhh4(t)*migrate/4);
    MhR4to5(t) = poissrnd(MhR4(t)*migrate/4);
    MRR4to5(t) = poissrnd(MRR4(t)*migrate/4);

    MHH_HH4to5(t) = poissrnd(MHH_HH4(t)*migrate/4);
    MHH_Hh4to5(t) = poissrnd(MHH_Hh4(t)*migrate/4);
    MHH_HR4to5(t) = poissrnd(MHH_HR4(t)*migrate/4);
    MHH_hh4to5(t) = poissrnd(MHH_hh4(t)*migrate/4);
    MHH_hR4to5(t) = poissrnd(MHH_hR4(t)*migrate/4);
    MHH_RR4to5(t) = poissrnd(MHH_RR4(t)*migrate/4);
    ...
    MHR_HH4to5(t) = poissrnd(MHR_HH4(t)*migrate/4);
    MHR_Hh4to5(t) = poissrnd(MHR_Hh4(t)*migrate/4);
    MHR_HR4to5(t) = poissrnd(MHR_HR4(t)*migrate/4);
    MHR_hh4to5(t) = poissrnd(MHR_hh4(t)*migrate/4);
    MHR_hR4to5(t) = poissrnd(MHR_hR4(t)*migrate/4);
    MHR_RR4to5(t) = poissrnd(MHR_RR4(t)*migrate/4);
    ...
    MRR_HH4to5(t) = poissrnd(MRR_HH4(t)*migrate/4);
    MRR_Hh4to5(t) = poissrnd(MRR_Hh4(t)*migrate/4);
    MRR_HR4to5(t) = poissrnd(MRR_HR4(t)*migrate/4);
    MRR_hh4to5(t) = poissrnd(MRR_hh4(t)*migrate/4);
    MRR_hR4to5(t) = poissrnd(MRR_hR4(t)*migrate/4);
    MRR_RR4to5(t) = poissrnd(MRR_RR4(t)*migrate/4);
    
    % Migrants pop 5 -> pop 1:
    MHH5to1(t) = poissrnd(MHH5(t)*migrate/4);
    MHh5to1(t) = poissrnd(MHh5(t)*migrate/4);
    MHR5to1(t) = poissrnd(MHR5(t)*migrate/4);
    Mhh5to1(t) = poissrnd(Mhh5(t)*migrate/4);
    MhR5to1(t) = poissrnd(MhR5(t)*migrate/4);
    MRR5to1(t) = poissrnd(MRR5(t)*migrate/4);

    MHH_HH5to1(t) = poissrnd(MHH_HH5(t)*migrate/4);
    MHH_Hh5to1(t) = poissrnd(MHH_Hh5(t)*migrate/4);
    MHH_HR5to1(t) = poissrnd(MHH_HR5(t)*migrate/4);
    MHH_hh5to1(t) = poissrnd(MHH_hh5(t)*migrate/4);
    MHH_hR5to1(t) = poissrnd(MHH_hR5(t)*migrate/4);
    MHH_RR5to1(t) = poissrnd(MHH_RR5(t)*migrate/4);
    ...
    MHR_HH5to1(t) = poissrnd(MHR_HH5(t)*migrate/4);
    MHR_Hh5to1(t) = poissrnd(MHR_Hh5(t)*migrate/4);
    MHR_HR5to1(t) = poissrnd(MHR_HR5(t)*migrate/4);
    MHR_hh5to1(t) = poissrnd(MHR_hh5(t)*migrate/4);
    MHR_hR5to1(t) = poissrnd(MHR_hR5(t)*migrate/4);
    MHR_RR5to1(t) = poissrnd(MHR_RR5(t)*migrate/4);
    ...
    MRR_HH5to1(t) = poissrnd(MRR_HH5(t)*migrate/4);
    MRR_Hh5to1(t) = poissrnd(MRR_Hh5(t)*migrate/4);
    MRR_HR5to1(t) = poissrnd(MRR_HR5(t)*migrate/4);
    MRR_hh5to1(t) = poissrnd(MRR_hh5(t)*migrate/4);
    MRR_hR5to1(t) = poissrnd(MRR_hR5(t)*migrate/4);
    MRR_RR5to1(t) = poissrnd(MRR_RR5(t)*migrate/4);

    % Migrants pop 5 -> pop 2:
    MHH5to2(t) = poissrnd(MHH5(t)*migrate/4);
    MHh5to2(t) = poissrnd(MHh5(t)*migrate/4);
    MHR5to2(t) = poissrnd(MHR5(t)*migrate/4);
    Mhh5to2(t) = poissrnd(Mhh5(t)*migrate/4);
    MhR5to2(t) = poissrnd(MhR5(t)*migrate/4);
    MRR5to2(t) = poissrnd(MRR5(t)*migrate/4);

    MHH_HH5to2(t) = poissrnd(MHH_HH5(t)*migrate/4);
    MHH_Hh5to2(t) = poissrnd(MHH_Hh5(t)*migrate/4);
    MHH_HR5to2(t) = poissrnd(MHH_HR5(t)*migrate/4);
    MHH_hh5to2(t) = poissrnd(MHH_hh5(t)*migrate/4);
    MHH_hR5to2(t) = poissrnd(MHH_hR5(t)*migrate/4);
    MHH_RR5to2(t) = poissrnd(MHH_RR5(t)*migrate/4);
    ...
    MHR_HH5to2(t) = poissrnd(MHR_HH5(t)*migrate/4);
    MHR_Hh5to2(t) = poissrnd(MHR_Hh5(t)*migrate/4);
    MHR_HR5to2(t) = poissrnd(MHR_HR5(t)*migrate/4);
    MHR_hh5to2(t) = poissrnd(MHR_hh5(t)*migrate/4);
    MHR_hR5to2(t) = poissrnd(MHR_hR5(t)*migrate/4);
    MHR_RR5to2(t) = poissrnd(MHR_RR5(t)*migrate/4);
    ...
    MRR_HH5to2(t) = poissrnd(MRR_HH5(t)*migrate/4);
    MRR_Hh5to2(t) = poissrnd(MRR_Hh5(t)*migrate/4);
    MRR_HR5to2(t) = poissrnd(MRR_HR5(t)*migrate/4);
    MRR_hh5to2(t) = poissrnd(MRR_hh5(t)*migrate/4);
    MRR_hR5to2(t) = poissrnd(MRR_hR5(t)*migrate/4);
    MRR_RR5to2(t) = poissrnd(MRR_RR5(t)*migrate/4);

    % Migrants pop 5 -> pop 3:
    MHH5to3(t) = poissrnd(MHH5(t)*migrate/4);
    MHh5to3(t) = poissrnd(MHh5(t)*migrate/4);
    MHR5to3(t) = poissrnd(MHR5(t)*migrate/4);
    Mhh5to3(t) = poissrnd(Mhh5(t)*migrate/4);
    MhR5to3(t) = poissrnd(MhR5(t)*migrate/4);
    MRR5to3(t) = poissrnd(MRR5(t)*migrate/4);

    MHH_HH5to3(t) = poissrnd(MHH_HH5(t)*migrate/4);
    MHH_Hh5to3(t) = poissrnd(MHH_Hh5(t)*migrate/4);
    MHH_HR5to3(t) = poissrnd(MHH_HR5(t)*migrate/4);
    MHH_hh5to3(t) = poissrnd(MHH_hh5(t)*migrate/4);
    MHH_hR5to3(t) = poissrnd(MHH_hR5(t)*migrate/4);
    MHH_RR5to3(t) = poissrnd(MHH_RR5(t)*migrate/4);
    ...
    MHR_HH5to3(t) = poissrnd(MHR_HH5(t)*migrate/4);
    MHR_Hh5to3(t) = poissrnd(MHR_Hh5(t)*migrate/4);
    MHR_HR5to3(t) = poissrnd(MHR_HR5(t)*migrate/4);
    MHR_hh5to3(t) = poissrnd(MHR_hh5(t)*migrate/4);
    MHR_hR5to3(t) = poissrnd(MHR_hR5(t)*migrate/4);
    MHR_RR5to3(t) = poissrnd(MHR_RR5(t)*migrate/4);
    ...
    MRR_HH5to3(t) = poissrnd(MRR_HH5(t)*migrate/4);
    MRR_Hh5to3(t) = poissrnd(MRR_Hh5(t)*migrate/4);
    MRR_HR5to3(t) = poissrnd(MRR_HR5(t)*migrate/4);
    MRR_hh5to3(t) = poissrnd(MRR_hh5(t)*migrate/4);
    MRR_hR5to3(t) = poissrnd(MRR_hR5(t)*migrate/4);
    MRR_RR5to3(t) = poissrnd(MRR_RR5(t)*migrate/4);

    % Migrants pop 5 -> pop 4:
    MHH5to4(t) = poissrnd(MHH5(t)*migrate/4);
    MHh5to4(t) = poissrnd(MHh5(t)*migrate/4);
    MHR5to4(t) = poissrnd(MHR5(t)*migrate/4);
    Mhh5to4(t) = poissrnd(Mhh5(t)*migrate/4);
    MhR5to4(t) = poissrnd(MhR5(t)*migrate/4);
    MRR5to4(t) = poissrnd(MRR5(t)*migrate/4);

    MHH_HH5to4(t) = poissrnd(MHH_HH5(t)*migrate/4);
    MHH_Hh5to4(t) = poissrnd(MHH_Hh5(t)*migrate/4);
    MHH_HR5to4(t) = poissrnd(MHH_HR5(t)*migrate/4);
    MHH_hh5to4(t) = poissrnd(MHH_hh5(t)*migrate/4);
    MHH_hR5to4(t) = poissrnd(MHH_hR5(t)*migrate/4);
    MHH_RR5to4(t) = poissrnd(MHH_RR5(t)*migrate/4);
    ...
    MHR_HH5to4(t) = poissrnd(MHR_HH5(t)*migrate/4);
    MHR_Hh5to4(t) = poissrnd(MHR_Hh5(t)*migrate/4);
    MHR_HR5to4(t) = poissrnd(MHR_HR5(t)*migrate/4);
    MHR_hh5to4(t) = poissrnd(MHR_hh5(t)*migrate/4);
    MHR_hR5to4(t) = poissrnd(MHR_hR5(t)*migrate/4);
    MHR_RR5to4(t) = poissrnd(MHR_RR5(t)*migrate/4);
    ...
    MRR_HH5to4(t) = poissrnd(MRR_HH5(t)*migrate/4);
    MRR_Hh5to4(t) = poissrnd(MRR_Hh5(t)*migrate/4);
    MRR_HR5to4(t) = poissrnd(MRR_HR5(t)*migrate/4);
    MRR_hh5to4(t) = poissrnd(MRR_hh5(t)*migrate/4);
    MRR_hR5to4(t) = poissrnd(MRR_hR5(t)*migrate/4);
    MRR_RR5to4(t) = poissrnd(MRR_RR5(t)*migrate/4);
    
    % Exchanging migrants:
    MHH1(t) = MHH1(t) - MHH1to2(t) - MHH1to3(t) - MHH1to4(t) - MHH1to5(t) + MHH2to1(t) + MHH3to1(t) + MHH4to1(t) + MHH5to1(t);
    MHh1(t) = MHh1(t) - MHh1to2(t) - MHh1to3(t) - MHh1to4(t) - MHh1to5(t) + MHh2to1(t) + MHh3to1(t) + MHh4to1(t) + MHh5to1(t);
    MHR1(t) = MHR1(t) - MHR1to2(t) - MHR1to3(t) - MHR1to4(t) - MHR1to5(t) + MHR2to1(t) + MHR3to1(t) + MHR4to1(t) + MHR5to1(t);
    Mhh1(t) = Mhh1(t) - Mhh1to2(t) - Mhh1to3(t) - Mhh1to4(t) - Mhh1to5(t) + Mhh2to1(t) + Mhh3to1(t) + Mhh4to1(t) + Mhh5to1(t);
    MhR1(t) = MhR1(t) - MhR1to2(t) - MhR1to3(t) - MhR1to4(t) - MhR1to5(t) + MhR2to1(t) + MhR3to1(t) + MhR4to1(t) + MhR5to1(t);
    MRR1(t) = MRR1(t) - MRR1to2(t) - MRR1to3(t) - MRR1to4(t) - MRR1to5(t) + MRR2to1(t) + MRR3to1(t) + MRR4to1(t) + MRR5to1(t);

    MHH_HH1(t) = MHH_HH1(t) - MHH_HH1to2(t) - MHH_HH1to3(t) - MHH_HH1to4(t) - MHH_HH1to5(t) + MHH_HH2to1(t) + MHH_HH3to1(t) + MHH_HH4to1(t) + MHH_HH5to1(t);
    MHH_Hh1(t) = MHH_Hh1(t) - MHH_Hh1to2(t) - MHH_Hh1to3(t) - MHH_Hh1to4(t) - MHH_Hh1to5(t) + MHH_Hh2to1(t) + MHH_Hh3to1(t) + MHH_Hh4to1(t) + MHH_Hh5to1(t);
    MHH_HR1(t) = MHH_HR1(t) - MHH_HR1to2(t) - MHH_HR1to3(t) - MHH_HR1to4(t) - MHH_HR1to5(t) + MHH_HR2to1(t) + MHH_HR3to1(t) + MHH_HR4to1(t) + MHH_HR5to1(t);
    MHH_hh1(t) = MHH_hh1(t) - MHH_hh1to2(t) - MHH_hh1to3(t) - MHH_hh1to4(t) - MHH_hh1to5(t) + MHH_hh2to1(t) + MHH_hh3to1(t) + MHH_hh4to1(t) + MHH_hh5to1(t);
    MHH_hR1(t) = MHH_hR1(t) - MHH_hR1to2(t) - MHH_hR1to3(t) - MHH_hR1to4(t) - MHH_hR1to5(t) + MHH_hR2to1(t) + MHH_hR3to1(t) + MHH_hR4to1(t) + MHH_hR5to1(t);
    MHH_RR1(t) = MHH_RR1(t) - MHH_RR1to2(t) - MHH_RR1to3(t) - MHH_RR1to4(t) - MHH_RR1to5(t) + MHH_RR2to1(t) + MHH_RR3to1(t) + MHH_RR4to1(t) + MHH_RR5to1(t);
    ...
    MHR_HH1(t) = MHR_HH1(t) - MHR_HH1to2(t) - MHR_HH1to3(t) - MHR_HH1to4(t) - MHR_HH1to5(t) + MHR_HH2to1(t) + MHR_HH3to1(t) + MHR_HH4to1(t) + MHR_HH5to1(t);
    MHR_Hh1(t) = MHR_Hh1(t) - MHR_Hh1to2(t) - MHR_Hh1to3(t) - MHR_Hh1to4(t) - MHR_Hh1to5(t) + MHR_Hh2to1(t) + MHR_Hh3to1(t) + MHR_Hh4to1(t) + MHR_Hh5to1(t);
    MHR_HR1(t) = MHR_HR1(t) - MHR_HR1to2(t) - MHR_HR1to3(t) - MHR_HR1to4(t) - MHR_HR1to5(t) + MHR_HR2to1(t) + MHR_HR3to1(t) + MHR_HR4to1(t) + MHR_HR5to1(t);
    MHR_hh1(t) = MHR_hh1(t) - MHR_hh1to2(t) - MHR_hh1to3(t) - MHR_hh1to4(t) - MHR_hh1to5(t) + MHR_hh2to1(t) + MHR_hh3to1(t) + MHR_hh4to1(t) + MHR_hh5to1(t);
    MHR_hR1(t) = MHR_hR1(t) - MHR_hR1to2(t) - MHR_hR1to3(t) - MHR_hR1to4(t) - MHR_hR1to5(t) + MHR_hR2to1(t) + MHR_hR3to1(t) + MHR_hR4to1(t) + MHR_hR5to1(t);
    MHR_RR1(t) = MHR_RR1(t) - MHR_RR1to2(t) - MHR_RR1to3(t) - MHR_RR1to4(t) - MHR_RR1to5(t) + MHR_RR2to1(t) + MHR_RR3to1(t) + MHR_RR4to1(t) + MHR_RR5to1(t);
    ...
    MRR_HH1(t) = MRR_HH1(t) - MRR_HH1to2(t) - MRR_HH1to3(t) - MRR_HH1to4(t) - MRR_HH1to5(t) + MRR_HH2to1(t) + MRR_HH3to1(t) + MRR_HH4to1(t) + MRR_HH5to1(t);
    MRR_Hh1(t) = MRR_Hh1(t) - MRR_Hh1to2(t) - MRR_Hh1to3(t) - MRR_Hh1to4(t) - MRR_Hh1to5(t) + MRR_Hh2to1(t) + MRR_Hh3to1(t) + MRR_Hh4to1(t) + MRR_Hh5to1(t);
    MRR_HR1(t) = MRR_HR1(t) - MRR_HR1to2(t) - MRR_HR1to3(t) - MRR_HR1to4(t) - MRR_HR1to5(t) + MRR_HR2to1(t) + MRR_HR3to1(t) + MRR_HR4to1(t) + MRR_HR5to1(t);
    MRR_hh1(t) = MRR_hh1(t) - MRR_hh1to2(t) - MRR_hh1to3(t) - MRR_hh1to4(t) - MRR_hh1to5(t) + MRR_hh2to1(t) + MRR_hh3to1(t) + MRR_hh4to1(t) + MRR_hh5to1(t);
    MRR_hR1(t) = MRR_hR1(t) - MRR_hR1to2(t) - MRR_hR1to3(t) - MRR_hR1to4(t) - MRR_hR1to5(t) + MRR_hR2to1(t) + MRR_hR3to1(t) + MRR_hR4to1(t) + MRR_hR5to1(t);
    MRR_RR1(t) = MRR_RR1(t) - MRR_RR1to2(t) - MRR_RR1to3(t) - MRR_RR1to4(t) - MRR_RR1to5(t) + MRR_RR2to1(t) + MRR_RR3to1(t) + MRR_RR4to1(t) + MRR_RR5to1(t);

    
    MHH2(t) = MHH2(t) - MHH2to1(t) - MHH2to3(t) - MHH2to4(t) - MHH2to5(t) + MHH1to2(t) + MHH3to2(t) + MHH4to2(t) + MHH5to2(t);
    MHh2(t) = MHh2(t) - MHh2to1(t) - MHh2to3(t) - MHh2to4(t) - MHh2to5(t) + MHh1to2(t) + MHh3to2(t) + MHh4to2(t) + MHh5to2(t);
    MHR2(t) = MHR2(t) - MHR2to1(t) - MHR2to3(t) - MHR2to4(t) - MHR2to5(t) + MHR1to2(t) + MHR3to2(t) + MHR4to2(t) + MHR5to2(t);
    Mhh2(t) = Mhh2(t) - Mhh2to1(t) - Mhh2to3(t) - Mhh2to4(t) - Mhh2to5(t) + Mhh1to2(t) + Mhh3to2(t) + Mhh4to2(t) + Mhh5to2(t);
    MhR2(t) = MhR2(t) - MhR2to1(t) - MhR2to3(t) - MhR2to4(t) - MhR2to5(t) + MhR1to2(t) + MhR3to2(t) + MhR4to2(t) + MhR5to2(t);
    MRR2(t) = MRR2(t) - MRR2to1(t) - MRR2to3(t) - MRR2to4(t) - MRR2to5(t) + MRR1to2(t) + MRR3to2(t) + MRR4to2(t) + MRR5to2(t);

    MHH_HH2(t) = MHH_HH2(t) - MHH_HH2to1(t) - MHH_HH2to3(t) - MHH_HH2to4(t) - MHH_HH2to5(t) + MHH_HH1to2(t) + MHH_HH3to2(t) + MHH_HH4to2(t) + MHH_HH5to2(t);
    MHH_Hh2(t) = MHH_Hh2(t) - MHH_Hh2to1(t) - MHH_Hh2to3(t) - MHH_Hh2to4(t) - MHH_Hh2to5(t) + MHH_Hh1to2(t) + MHH_Hh3to2(t) + MHH_Hh4to2(t) + MHH_Hh5to2(t);
    MHH_HR2(t) = MHH_HR2(t) - MHH_HR2to1(t) - MHH_HR2to3(t) - MHH_HR2to4(t) - MHH_HR2to5(t) + MHH_HR1to2(t) + MHH_HR3to2(t) + MHH_HR4to2(t) + MHH_HR5to2(t);
    MHH_hh2(t) = MHH_hh2(t) - MHH_hh2to1(t) - MHH_hh2to3(t) - MHH_hh2to4(t) - MHH_hh2to5(t) + MHH_hh1to2(t) + MHH_hh3to2(t) + MHH_hh4to2(t) + MHH_hh5to2(t);
    MHH_hR2(t) = MHH_hR2(t) - MHH_hR2to1(t) - MHH_hR2to3(t) - MHH_hR2to4(t) - MHH_hR2to5(t) + MHH_hR1to2(t) + MHH_hR3to2(t) + MHH_hR4to2(t) + MHH_hR5to2(t);
    MHH_RR2(t) = MHH_RR2(t) - MHH_RR2to1(t) - MHH_RR2to3(t) - MHH_RR2to4(t) - MHH_RR2to5(t) + MHH_RR1to2(t) + MHH_RR3to2(t) + MHH_RR4to2(t) + MHH_RR5to2(t);
    ...
    MHR_HH2(t) = MHR_HH2(t) - MHR_HH2to1(t) - MHR_HH2to3(t) - MHR_HH2to4(t) - MHR_HH2to5(t) + MHR_HH1to2(t) + MHR_HH3to2(t) + MHR_HH4to2(t) + MHR_HH5to2(t);
    MHR_Hh2(t) = MHR_Hh2(t) - MHR_Hh2to1(t) - MHR_Hh2to3(t) - MHR_Hh2to4(t) - MHR_Hh2to5(t) + MHR_Hh1to2(t) + MHR_Hh3to2(t) + MHR_Hh4to2(t) + MHR_Hh5to2(t);
    MHR_HR2(t) = MHR_HR2(t) - MHR_HR2to1(t) - MHR_HR2to3(t) - MHR_HR2to4(t) - MHR_HR2to5(t) + MHR_HR1to2(t) + MHR_HR3to2(t) + MHR_HR4to2(t) + MHR_HR5to2(t);
    MHR_hh2(t) = MHR_hh2(t) - MHR_hh2to1(t) - MHR_hh2to3(t) - MHR_hh2to4(t) - MHR_hh2to5(t) + MHR_hh1to2(t) + MHR_hh3to2(t) + MHR_hh4to2(t) + MHR_hh5to2(t);
    MHR_hR2(t) = MHR_hR2(t) - MHR_hR2to1(t) - MHR_hR2to3(t) - MHR_hR2to4(t) - MHR_hR2to5(t) + MHR_hR1to2(t) + MHR_hR3to2(t) + MHR_hR4to2(t) + MHR_hR5to2(t);
    MHR_RR2(t) = MHR_RR2(t) - MHR_RR2to1(t) - MHR_RR2to3(t) - MHR_RR2to4(t) - MHR_RR2to5(t) + MHR_RR1to2(t) + MHR_RR3to2(t) + MHR_RR4to2(t) + MHR_RR5to2(t);
    ...
    MRR_HH2(t) = MRR_HH2(t) - MRR_HH2to1(t) - MRR_HH2to3(t) - MRR_HH2to4(t) - MRR_HH2to5(t) + MRR_HH1to2(t) + MRR_HH3to2(t) + MRR_HH4to2(t) + MRR_HH5to2(t);
    MRR_Hh2(t) = MRR_Hh2(t) - MRR_Hh2to1(t) - MRR_Hh2to3(t) - MRR_Hh2to4(t) - MRR_Hh2to5(t) + MRR_Hh1to2(t) + MRR_Hh3to2(t) + MRR_Hh4to2(t) + MRR_Hh5to2(t);
    MRR_HR2(t) = MRR_HR2(t) - MRR_HR2to1(t) - MRR_HR2to3(t) - MRR_HR2to4(t) - MRR_HR2to5(t) + MRR_HR1to2(t) + MRR_HR3to2(t) + MRR_HR4to2(t) + MRR_HR5to2(t);
    MRR_hh2(t) = MRR_hh2(t) - MRR_hh2to1(t) - MRR_hh2to3(t) - MRR_hh2to4(t) - MRR_hh2to5(t) + MRR_hh1to2(t) + MRR_hh3to2(t) + MRR_hh4to2(t) + MRR_hh5to2(t);
    MRR_hR2(t) = MRR_hR2(t) - MRR_hR2to1(t) - MRR_hR2to3(t) - MRR_hR2to4(t) - MRR_hR2to5(t) + MRR_hR1to2(t) + MRR_hR3to2(t) + MRR_hR4to2(t) + MRR_hR5to2(t);
    MRR_RR2(t) = MRR_RR2(t) - MRR_RR2to1(t) - MRR_RR2to3(t) - MRR_RR2to4(t) - MRR_RR2to5(t) + MRR_RR1to2(t) + MRR_RR3to2(t) + MRR_RR4to2(t) + MRR_RR5to2(t);

    
    MHH3(t) = MHH3(t) - MHH3to2(t) - MHH3to1(t) - MHH3to4(t) - MHH3to5(t) + MHH2to3(t) + MHH1to3(t) + MHH4to3(t) + MHH5to3(t);
    MHh3(t) = MHh3(t) - MHh3to2(t) - MHh3to1(t) - MHh3to4(t) - MHh3to5(t) + MHh2to3(t) + MHh1to3(t) + MHh4to3(t) + MHh5to3(t);
    MHR3(t) = MHR3(t) - MHR3to2(t) - MHR3to1(t) - MHR3to4(t) - MHR3to5(t) + MHR2to3(t) + MHR1to3(t) + MHR4to3(t) + MHR5to3(t);
    Mhh3(t) = Mhh3(t) - Mhh3to2(t) - Mhh3to1(t) - Mhh3to4(t) - Mhh3to5(t) + Mhh2to3(t) + Mhh1to3(t) + Mhh4to3(t) + Mhh5to3(t);
    MhR3(t) = MhR3(t) - MhR3to2(t) - MhR3to1(t) - MhR3to4(t) - MhR3to5(t) + MhR2to3(t) + MhR1to3(t) + MhR4to3(t) + MhR5to3(t);
    MRR3(t) = MRR3(t) - MRR3to2(t) - MRR3to1(t) - MRR3to4(t) - MRR3to5(t) + MRR2to3(t) + MRR1to3(t) + MRR4to3(t) + MRR5to3(t);

    MHH_HH3(t) = MHH_HH3(t) - MHH_HH3to2(t) - MHH_HH3to1(t) - MHH_HH3to4(t) - MHH_HH3to5(t) + MHH_HH2to3(t) + MHH_HH1to3(t) + MHH_HH4to3(t) + MHH_HH5to3(t);
    MHH_Hh3(t) = MHH_Hh3(t) - MHH_Hh3to2(t) - MHH_Hh3to1(t) - MHH_Hh3to4(t) - MHH_Hh3to5(t) + MHH_Hh2to3(t) + MHH_Hh1to3(t) + MHH_Hh4to3(t) + MHH_Hh5to3(t);
    MHH_HR3(t) = MHH_HR3(t) - MHH_HR3to2(t) - MHH_HR3to1(t) - MHH_HR3to4(t) - MHH_HR3to5(t) + MHH_HR2to3(t) + MHH_HR1to3(t) + MHH_HR4to3(t) + MHH_HR5to3(t);
    MHH_hh3(t) = MHH_hh3(t) - MHH_hh3to2(t) - MHH_hh3to1(t) - MHH_hh3to4(t) - MHH_hh3to5(t) + MHH_hh2to3(t) + MHH_hh1to3(t) + MHH_hh4to3(t) + MHH_hh5to3(t);
    MHH_hR3(t) = MHH_hR3(t) - MHH_hR3to2(t) - MHH_hR3to1(t) - MHH_hR3to4(t) - MHH_hR3to5(t) + MHH_hR2to3(t) + MHH_hR1to3(t) + MHH_hR4to3(t) + MHH_hR5to3(t);
    MHH_RR3(t) = MHH_RR3(t) - MHH_RR3to2(t) - MHH_RR3to1(t) - MHH_RR3to4(t) - MHH_RR3to5(t) + MHH_RR2to3(t) + MHH_RR1to3(t) + MHH_RR4to3(t) + MHH_RR5to3(t);
    ...
    MHR_HH3(t) = MHR_HH3(t) - MHR_HH3to2(t) - MHR_HH3to1(t) - MHR_HH3to4(t) - MHR_HH3to5(t) + MHR_HH2to3(t) + MHR_HH1to3(t) + MHR_HH4to3(t) + MHR_HH5to3(t);
    MHR_Hh3(t) = MHR_Hh3(t) - MHR_Hh3to2(t) - MHR_Hh3to1(t) - MHR_Hh3to4(t) - MHR_Hh3to5(t) + MHR_Hh2to3(t) + MHR_Hh1to3(t) + MHR_Hh4to3(t) + MHR_Hh5to3(t);
    MHR_HR3(t) = MHR_HR3(t) - MHR_HR3to2(t) - MHR_HR3to1(t) - MHR_HR3to4(t) - MHR_HR3to5(t) + MHR_HR2to3(t) + MHR_HR1to3(t) + MHR_HR4to3(t) + MHR_HR5to3(t);
    MHR_hh3(t) = MHR_hh3(t) - MHR_hh3to2(t) - MHR_hh3to1(t) - MHR_hh3to4(t) - MHR_hh3to5(t) + MHR_hh2to3(t) + MHR_hh1to3(t) + MHR_hh4to3(t) + MHR_hh5to3(t);
    MHR_hR3(t) = MHR_hR3(t) - MHR_hR3to2(t) - MHR_hR3to1(t) - MHR_hR3to4(t) - MHR_hR3to5(t) + MHR_hR2to3(t) + MHR_hR1to3(t) + MHR_hR4to3(t) + MHR_hR5to3(t);
    MHR_RR3(t) = MHR_RR3(t) - MHR_RR3to2(t) - MHR_RR3to1(t) - MHR_RR3to4(t) - MHR_RR3to5(t) + MHR_RR2to3(t) + MHR_RR1to3(t) + MHR_RR4to3(t) + MHR_RR5to3(t);
    ...
    MRR_HH3(t) = MRR_HH3(t) - MRR_HH3to2(t) - MRR_HH3to1(t) - MRR_HH3to4(t) - MRR_HH3to5(t) + MRR_HH2to3(t) + MRR_HH1to3(t) + MRR_HH4to3(t) + MRR_HH5to3(t);
    MRR_Hh3(t) = MRR_Hh3(t) - MRR_Hh3to2(t) - MRR_Hh3to1(t) - MRR_Hh3to4(t) - MRR_Hh3to5(t) + MRR_Hh2to3(t) + MRR_Hh1to3(t) + MRR_Hh4to3(t) + MRR_Hh5to3(t);
    MRR_HR3(t) = MRR_HR3(t) - MRR_HR3to2(t) - MRR_HR3to1(t) - MRR_HR3to4(t) - MRR_HR3to5(t) + MRR_HR2to3(t) + MRR_HR1to3(t) + MRR_HR4to3(t) + MRR_HR5to3(t);
    MRR_hh3(t) = MRR_hh3(t) - MRR_hh3to2(t) - MRR_hh3to1(t) - MRR_hh3to4(t) - MRR_hh3to5(t) + MRR_hh2to3(t) + MRR_hh1to3(t) + MRR_hh4to3(t) + MRR_hh5to3(t);
    MRR_hR3(t) = MRR_hR3(t) - MRR_hR3to2(t) - MRR_hR3to1(t) - MRR_hR3to4(t) - MRR_hR3to5(t) + MRR_hR2to3(t) + MRR_hR1to3(t) + MRR_hR4to3(t) + MRR_hR5to3(t);
    MRR_RR3(t) = MRR_RR3(t) - MRR_RR3to2(t) - MRR_RR3to1(t) - MRR_RR3to4(t) - MRR_RR3to5(t) + MRR_RR2to3(t) + MRR_RR1to3(t) + MRR_RR4to3(t) + MRR_RR5to3(t);

    
    MHH4(t) = MHH4(t) - MHH4to2(t) - MHH4to3(t) - MHH4to1(t) - MHH4to5(t) + MHH2to4(t) + MHH3to4(t) + MHH1to4(t) + MHH5to4(t);
    MHh4(t) = MHh4(t) - MHh4to2(t) - MHh4to3(t) - MHh4to1(t) - MHh4to5(t) + MHh2to4(t) + MHh3to4(t) + MHh1to4(t) + MHh5to4(t);
    MHR4(t) = MHR4(t) - MHR4to2(t) - MHR4to3(t) - MHR4to1(t) - MHR4to5(t) + MHR2to4(t) + MHR3to4(t) + MHR1to4(t) + MHR5to4(t);
    Mhh4(t) = Mhh4(t) - Mhh4to2(t) - Mhh4to3(t) - Mhh4to1(t) - Mhh4to5(t) + Mhh2to4(t) + Mhh3to4(t) + Mhh1to4(t) + Mhh5to4(t);
    MhR4(t) = MhR4(t) - MhR4to2(t) - MhR4to3(t) - MhR4to1(t) - MhR4to5(t) + MhR2to4(t) + MhR3to4(t) + MhR1to4(t) + MhR5to4(t);
    MRR4(t) = MRR4(t) - MRR4to2(t) - MRR4to3(t) - MRR4to1(t) - MRR4to5(t) + MRR2to4(t) + MRR3to4(t) + MRR1to4(t) + MRR5to4(t);

    MHH_HH4(t) = MHH_HH4(t) - MHH_HH4to2(t) - MHH_HH4to3(t) - MHH_HH4to1(t) - MHH_HH4to5(t) + MHH_HH2to4(t) + MHH_HH3to4(t) + MHH_HH1to4(t) + MHH_HH5to4(t);
    MHH_Hh4(t) = MHH_Hh4(t) - MHH_Hh4to2(t) - MHH_Hh4to3(t) - MHH_Hh4to1(t) - MHH_Hh4to5(t) + MHH_Hh2to4(t) + MHH_Hh3to4(t) + MHH_Hh1to4(t) + MHH_Hh5to4(t);
    MHH_HR4(t) = MHH_HR4(t) - MHH_HR4to2(t) - MHH_HR4to3(t) - MHH_HR4to1(t) - MHH_HR4to5(t) + MHH_HR2to4(t) + MHH_HR3to4(t) + MHH_HR1to4(t) + MHH_HR5to4(t);
    MHH_hh4(t) = MHH_hh4(t) - MHH_hh4to2(t) - MHH_hh4to3(t) - MHH_hh4to1(t) - MHH_hh4to5(t) + MHH_hh2to4(t) + MHH_hh3to4(t) + MHH_hh1to4(t) + MHH_hh5to4(t);
    MHH_hR4(t) = MHH_hR4(t) - MHH_hR4to2(t) - MHH_hR4to3(t) - MHH_hR4to1(t) - MHH_hR4to5(t) + MHH_hR2to4(t) + MHH_hR3to4(t) + MHH_hR1to4(t) + MHH_hR5to4(t);
    MHH_RR4(t) = MHH_RR4(t) - MHH_RR4to2(t) - MHH_RR4to3(t) - MHH_RR4to1(t) - MHH_RR4to5(t) + MHH_RR2to4(t) + MHH_RR3to4(t) + MHH_RR1to4(t) + MHH_RR5to4(t);
    ...
    MHR_HH4(t) = MHR_HH4(t) - MHR_HH4to2(t) - MHR_HH4to3(t) - MHR_HH4to1(t) - MHR_HH4to5(t) + MHR_HH2to4(t) + MHR_HH3to4(t) + MHR_HH1to4(t) + MHR_HH5to4(t);
    MHR_Hh4(t) = MHR_Hh4(t) - MHR_Hh4to2(t) - MHR_Hh4to3(t) - MHR_Hh4to1(t) - MHR_Hh4to5(t) + MHR_Hh2to4(t) + MHR_Hh3to4(t) + MHR_Hh1to4(t) + MHR_Hh5to4(t);
    MHR_HR4(t) = MHR_HR4(t) - MHR_HR4to2(t) - MHR_HR4to3(t) - MHR_HR4to1(t) - MHR_HR4to5(t) + MHR_HR2to4(t) + MHR_HR3to4(t) + MHR_HR1to4(t) + MHR_HR5to4(t);
    MHR_hh4(t) = MHR_hh4(t) - MHR_hh4to2(t) - MHR_hh4to3(t) - MHR_hh4to1(t) - MHR_hh4to5(t) + MHR_hh2to4(t) + MHR_hh3to4(t) + MHR_hh1to4(t) + MHR_hh5to4(t);
    MHR_hR4(t) = MHR_hR4(t) - MHR_hR4to2(t) - MHR_hR4to3(t) - MHR_hR4to1(t) - MHR_hR4to5(t) + MHR_hR2to4(t) + MHR_hR3to4(t) + MHR_hR1to4(t) + MHR_hR5to4(t);
    MHR_RR4(t) = MHR_RR4(t) - MHR_RR4to2(t) - MHR_RR4to3(t) - MHR_RR4to1(t) - MHR_RR4to5(t) + MHR_RR2to4(t) + MHR_RR3to4(t) + MHR_RR1to4(t) + MHR_RR5to4(t);
    ...
    MRR_HH4(t) = MRR_HH4(t) - MRR_HH4to2(t) - MRR_HH4to3(t) - MRR_HH4to1(t) - MRR_HH4to5(t) + MRR_HH2to4(t) + MRR_HH3to4(t) + MRR_HH1to4(t) + MRR_HH5to4(t);
    MRR_Hh4(t) = MRR_Hh4(t) - MRR_Hh4to2(t) - MRR_Hh4to3(t) - MRR_Hh4to1(t) - MRR_Hh4to5(t) + MRR_Hh2to4(t) + MRR_Hh3to4(t) + MRR_Hh1to4(t) + MRR_Hh5to4(t);
    MRR_HR4(t) = MRR_HR4(t) - MRR_HR4to2(t) - MRR_HR4to3(t) - MRR_HR4to1(t) - MRR_HR4to5(t) + MRR_HR2to4(t) + MRR_HR3to4(t) + MRR_HR1to4(t) + MRR_HR5to4(t);
    MRR_hh4(t) = MRR_hh4(t) - MRR_hh4to2(t) - MRR_hh4to3(t) - MRR_hh4to1(t) - MRR_hh4to5(t) + MRR_hh2to4(t) + MRR_hh3to4(t) + MRR_hh1to4(t) + MRR_hh5to4(t);
    MRR_hR4(t) = MRR_hR4(t) - MRR_hR4to2(t) - MRR_hR4to3(t) - MRR_hR4to1(t) - MRR_hR4to5(t) + MRR_hR2to4(t) + MRR_hR3to4(t) + MRR_hR1to4(t) + MRR_hR5to4(t);
    MRR_RR4(t) = MRR_RR4(t) - MRR_RR4to2(t) - MRR_RR4to3(t) - MRR_RR4to1(t) - MRR_RR4to5(t) + MRR_RR2to4(t) + MRR_RR3to4(t) + MRR_RR1to4(t) + MRR_RR5to4(t);


    MHH5(t) = MHH5(t) - MHH5to2(t) - MHH5to3(t) - MHH5to4(t) - MHH5to1(t) + MHH2to5(t) + MHH3to5(t) + MHH4to5(t) + MHH1to5(t);
    MHh5(t) = MHh5(t) - MHh5to2(t) - MHh5to3(t) - MHh5to4(t) - MHh5to1(t) + MHh2to5(t) + MHh3to5(t) + MHh4to5(t) + MHh1to5(t);
    MHR5(t) = MHR5(t) - MHR5to2(t) - MHR5to3(t) - MHR5to4(t) - MHR5to1(t) + MHR2to5(t) + MHR3to5(t) + MHR4to5(t) + MHR1to5(t);
    Mhh5(t) = Mhh5(t) - Mhh5to2(t) - Mhh5to3(t) - Mhh5to4(t) - Mhh5to1(t) + Mhh2to5(t) + Mhh3to5(t) + Mhh4to5(t) + Mhh1to5(t);
    MhR5(t) = MhR5(t) - MhR5to2(t) - MhR5to3(t) - MhR5to4(t) - MhR5to1(t) + MhR2to5(t) + MhR3to5(t) + MhR4to5(t) + MhR1to5(t);
    MRR5(t) = MRR5(t) - MRR5to2(t) - MRR5to3(t) - MRR5to4(t) - MRR5to1(t) + MRR2to5(t) + MRR3to5(t) + MRR4to5(t) + MRR1to5(t);

    MHH_HH5(t) = MHH_HH5(t) - MHH_HH5to2(t) - MHH_HH5to3(t) - MHH_HH5to4(t) - MHH_HH5to1(t) + MHH_HH2to5(t) + MHH_HH3to5(t) + MHH_HH4to5(t) + MHH_HH1to5(t);
    MHH_Hh5(t) = MHH_Hh5(t) - MHH_Hh5to2(t) - MHH_Hh5to3(t) - MHH_Hh5to4(t) - MHH_Hh5to1(t) + MHH_Hh2to5(t) + MHH_Hh3to5(t) + MHH_Hh4to5(t) + MHH_Hh1to5(t);
    MHH_HR5(t) = MHH_HR5(t) - MHH_HR5to2(t) - MHH_HR5to3(t) - MHH_HR5to4(t) - MHH_HR5to1(t) + MHH_HR2to5(t) + MHH_HR3to5(t) + MHH_HR4to5(t) + MHH_HR1to5(t);
    MHH_hh5(t) = MHH_hh5(t) - MHH_hh5to2(t) - MHH_hh5to3(t) - MHH_hh5to4(t) - MHH_hh5to1(t) + MHH_hh2to5(t) + MHH_hh3to5(t) + MHH_hh4to5(t) + MHH_hh1to5(t);
    MHH_hR5(t) = MHH_hR5(t) - MHH_hR5to2(t) - MHH_hR5to3(t) - MHH_hR5to4(t) - MHH_hR5to1(t) + MHH_hR2to5(t) + MHH_hR3to5(t) + MHH_hR4to5(t) + MHH_hR1to5(t);
    MHH_RR5(t) = MHH_RR5(t) - MHH_RR5to2(t) - MHH_RR5to3(t) - MHH_RR5to4(t) - MHH_RR5to1(t) + MHH_RR2to5(t) + MHH_RR3to5(t) + MHH_RR4to5(t) + MHH_RR1to5(t);
    ...
    MHR_HH5(t) = MHR_HH5(t) - MHR_HH5to2(t) - MHR_HH5to3(t) - MHR_HH5to4(t) - MHR_HH5to1(t) + MHR_HH2to5(t) + MHR_HH3to5(t) + MHR_HH4to5(t) + MHR_HH1to5(t);
    MHR_Hh5(t) = MHR_Hh5(t) - MHR_Hh5to2(t) - MHR_Hh5to3(t) - MHR_Hh5to4(t) - MHR_Hh5to1(t) + MHR_Hh2to5(t) + MHR_Hh3to5(t) + MHR_Hh4to5(t) + MHR_Hh1to5(t);
    MHR_HR5(t) = MHR_HR5(t) - MHR_HR5to2(t) - MHR_HR5to3(t) - MHR_HR5to4(t) - MHR_HR5to1(t) + MHR_HR2to5(t) + MHR_HR3to5(t) + MHR_HR4to5(t) + MHR_HR1to5(t);
    MHR_hh5(t) = MHR_hh5(t) - MHR_hh5to2(t) - MHR_hh5to3(t) - MHR_hh5to4(t) - MHR_hh5to1(t) + MHR_hh2to5(t) + MHR_hh3to5(t) + MHR_hh4to5(t) + MHR_hh1to5(t);
    MHR_hR5(t) = MHR_hR5(t) - MHR_hR5to2(t) - MHR_hR5to3(t) - MHR_hR5to4(t) - MHR_hR5to1(t) + MHR_hR2to5(t) + MHR_hR3to5(t) + MHR_hR4to5(t) + MHR_hR1to5(t);
    MHR_RR5(t) = MHR_RR5(t) - MHR_RR5to2(t) - MHR_RR5to3(t) - MHR_RR5to4(t) - MHR_RR5to1(t) + MHR_RR2to5(t) + MHR_RR3to5(t) + MHR_RR4to5(t) + MHR_RR1to5(t);
    ...
    MRR_HH5(t) = MRR_HH5(t) - MRR_HH5to2(t) - MRR_HH5to3(t) - MRR_HH5to4(t) - MRR_HH5to1(t) + MRR_HH2to5(t) + MRR_HH3to5(t) + MRR_HH4to5(t) + MRR_HH1to5(t);
    MRR_Hh5(t) = MRR_Hh5(t) - MRR_Hh5to2(t) - MRR_Hh5to3(t) - MRR_Hh5to4(t) - MRR_Hh5to1(t) + MRR_Hh2to5(t) + MRR_Hh3to5(t) + MRR_Hh4to5(t) + MRR_Hh1to5(t);
    MRR_HR5(t) = MRR_HR5(t) - MRR_HR5to2(t) - MRR_HR5to3(t) - MRR_HR5to4(t) - MRR_HR5to1(t) + MRR_HR2to5(t) + MRR_HR3to5(t) + MRR_HR4to5(t) + MRR_HR1to5(t);
    MRR_hh5(t) = MRR_hh5(t) - MRR_hh5to2(t) - MRR_hh5to3(t) - MRR_hh5to4(t) - MRR_hh5to1(t) + MRR_hh2to5(t) + MRR_hh3to5(t) + MRR_hh4to5(t) + MRR_hh1to5(t);
    MRR_hR5(t) = MRR_hR5(t) - MRR_hR5to2(t) - MRR_hR5to3(t) - MRR_hR5to4(t) - MRR_hR5to1(t) + MRR_hR2to5(t) + MRR_hR3to5(t) + MRR_hR4to5(t) + MRR_hR1to5(t);
    MRR_RR5(t) = MRR_RR5(t) - MRR_RR5to2(t) - MRR_RR5to3(t) - MRR_RR5to4(t) - MRR_RR5to1(t) + MRR_RR2to5(t) + MRR_RR3to5(t) + MRR_RR4to5(t) + MRR_RR1to5(t);
 end
...
Mm5 = MHH5 + MHh5 + MHR5 + Mhh5 + MhR5 + MRR5;
Mf5 = MHH_HH5 + MHH_Hh5+ MHH_HR5 + MHH_hh5 + MHH_hR5+ MHH_RR5 + MHh_HH5 + MHh_Hh5+ MHh_HR5 + MHh_hh5 + MHh_hR5+ MHh_RR5 + MHR_HH5 + MHR_Hh5 + MHR_HR5 + MHR_hh5 + MHR_hR5+ MHR_RR5 + Mhh_HH5 + Mhh_Hh5 + Mhh_HR5 + Mhh_hh5 + Mhh_hR5+ Mhh_RR5 + MhR_HH5 + MhR_Hh5 + MhR_HR5 + MhR_hh5 + MhR_hR5+ MhR_RR5 + MRR_HH5 + MRR_Hh5 + MRR_HR5 + MRR_hh5 + MRR_hR5+ MRR_RR5;
M5  = Mm5 + Mf5;
% Mtransgenic5 = Mm5 + Mf5 - Mhh5 - (Mhh_HH5 + Mhh_Hh5 + Mhh_HR5 + Mhh_hh5 + Mhh_hR5+ Mhh_RR5);
% Mf_transgenic5 = Mf5 - (Mhh_HH5 + Mhh_Hh5 + Mhh_HR5 + Mhh_hh5 + Mhh_hR5+ Mhh_RR5);
MhomingAllele5 = MHH5 + MHh5 + MHH_HH5 + MHH_Hh5 + MHH_HR5 + MHH_hh5 + MHH_hR5 + MHH_RR5 + MHh_HH5 + MHh_Hh5 + MHh_HR5 + MHh_hh5 + MHh_hR5 + MHh_RR5;
MresistantAllele5 = MHR5 + MhR5 + MRR5 + MHR_HH5 + MHR_Hh5 + MHR_HR5 + MHR_hh5 + MHR_hR5 + MHR_RR5 + MhR_HH5 + MhR_Hh5 + MhR_HR5 + MhR_hh5 + MhR_hR5 + MhR_RR5 + MRR_HH5 + MRR_Hh5 + MRR_HR5 + MRR_hh5 + MRR_hR5+ MRR_RR5;

Mm = Mm1 + Mm2 + Mm3 + Mm4 + Mm5;
Mf = Mf1 + Mf2 + Mf3 + Mf4 + Mf5;
M = M1 + M2 + M3 + M4 + M5;
MhomingAllele = MhomingAllele1 + MhomingAllele2 + MhomingAllele3 + MhomingAllele4 + MhomingAllele5;
MresistantAllele = MresistantAllele1 + MresistantAllele2 + MresistantAllele3 + MresistantAllele4 + MresistantAllele5;



finalArray = [MhomingAllele; MresistantAllele; M];
strM = 1000000000000;
idString = [int2str(floor(rho*strM)) '_' int2str(floor(e*strM)) '_' int2str(floor(s*strM)) '_' int2str(floor(M_eq*strM*5)) '_' fileID];
