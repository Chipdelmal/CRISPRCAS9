...
repetitions = 100;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sVector     = 0.907;                                            %linspace(0,1,resolution);
rhoVector   =  0.0013;                        %linspace(0,1,resolution);
    ...
    %for j=1:length(MeqValue)
        %for i=1:length(rhoVector)
            parfor repetition = 1:repetitions
                iterateOneSimStep(rhoVector,eVector,sVector,MeqValue,int2str(randi([0 1000000000],1)),'./Data/');
            end
