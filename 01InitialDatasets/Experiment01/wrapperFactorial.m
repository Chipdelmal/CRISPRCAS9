...
rhoVector   = [.01 .00001 .0000001];                        %linspace(0,1,resolution);
eVector     = .98;                                          %linspace(0,1,resolution);
MeqValue    = [1000 10000 100000]                           %linspace(1000,100000,resolutionPop);           %1000;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for j=1:length(MeqValue)
        for i=1:length(rhoVector)
            parfor repetition = 1:repetitions
                iterateOneSimStep(rhoVector(i),eVector,sVector,MeqValue(j),int2str(randi([0 1000000000],1)),'./Data2/');
            end
