...
for t = 51:max_t
    ...
    if (t==51)
        MHH3(t) = MHH3(t) + M_eq;
        % MHH_HH3(t) = MHH_HH3(t) + M_eq/2;
    end
    
    % Migrants pop 1 -> pop 2:
    MHH1to2(t) = poissrnd(MHH1(t)*migrate/2);
    MHh1to2(t) = poissrnd(MHh1(t)*migrate/2);
    MHR1to2(t) = poissrnd(MHR1(t)*migrate/2);
    Mhh1to2(t) = poissrnd(Mhh1(t)*migrate/2);
    MhR1to2(t) = poissrnd(MhR1(t)*migrate/2);
    MRR1to2(t) = poissrnd(MRR1(t)*migrate/2);

    MHH_HH1to2(t) = poissrnd(MHH_HH1(t)*migrate/2);
    MHH_Hh1to2(t) = poissrnd(MHH_Hh1(t)*migrate/2);
    MHH_HR1to2(t) = poissrnd(MHH_HR1(t)*migrate/2);
    MHH_hh1to2(t) = poissrnd(MHH_hh1(t)*migrate/2);
    MHH_hR1to2(t) = poissrnd(MHH_hR1(t)*migrate/2);
    MHH_RR1to2(t) = poissrnd(MHH_RR1(t)*migrate/2);
    ...
    MHR_HH1to2(t) = poissrnd(MHR_HH1(t)*migrate/2);
    MHR_Hh1to2(t) = poissrnd(MHR_Hh1(t)*migrate/2);
    MHR_HR1to2(t) = poissrnd(MHR_HR1(t)*migrate/2);
    MHR_hh1to2(t) = poissrnd(MHR_hh1(t)*migrate/2);
    MHR_hR1to2(t) = poissrnd(MHR_hR1(t)*migrate/2);
    MHR_RR1to2(t) = poissrnd(MHR_RR1(t)*migrate/2);
    ...
    MRR_HH1to2(t) = poissrnd(MRR_HH1(t)*migrate/2);
    MRR_Hh1to2(t) = poissrnd(MRR_Hh1(t)*migrate/2);
    MRR_HR1to2(t) = poissrnd(MRR_HR1(t)*migrate/2);
    MRR_hh1to2(t) = poissrnd(MRR_hh1(t)*migrate/2);
    MRR_hR1to2(t) = poissrnd(MRR_hR1(t)*migrate/2);
    MRR_RR1to2(t) = poissrnd(MRR_RR1(t)*migrate/2);

    % Migrants pop 1 -> pop 3:
    MHH1to3(t) = poissrnd(MHH1(t)*migrate/2);
    MHh1to3(t) = poissrnd(MHh1(t)*migrate/2);
    MHR1to3(t) = poissrnd(MHR1(t)*migrate/2);
    Mhh1to3(t) = poissrnd(Mhh1(t)*migrate/2);
    MhR1to3(t) = poissrnd(MhR1(t)*migrate/2);
    MRR1to3(t) = poissrnd(MRR1(t)*migrate/2);

    MHH_HH1to3(t) = poissrnd(MHH_HH1(t)*migrate/2);
    MHH_Hh1to3(t) = poissrnd(MHH_Hh1(t)*migrate/2);
    MHH_HR1to3(t) = poissrnd(MHH_HR1(t)*migrate/2);
    MHH_hh1to3(t) = poissrnd(MHH_hh1(t)*migrate/2);
    MHH_hR1to3(t) = poissrnd(MHH_hR1(t)*migrate/2);
    MHH_RR1to3(t) = poissrnd(MHH_RR1(t)*migrate/2);
    ...
    MHR_HH1to3(t) = poissrnd(MHR_HH1(t)*migrate/2);
    MHR_Hh1to3(t) = poissrnd(MHR_Hh1(t)*migrate/2);
    MHR_HR1to3(t) = poissrnd(MHR_HR1(t)*migrate/2);
    MHR_hh1to3(t) = poissrnd(MHR_hh1(t)*migrate/2);
    MHR_hR1to3(t) = poissrnd(MHR_hR1(t)*migrate/2);
    MHR_RR1to3(t) = poissrnd(MHR_RR1(t)*migrate/2);
    ...
    MRR_HH1to3(t) = poissrnd(MRR_HH1(t)*migrate/2);
    MRR_Hh1to3(t) = poissrnd(MRR_Hh1(t)*migrate/2);
    MRR_HR1to3(t) = poissrnd(MRR_HR1(t)*migrate/2);
    MRR_hh1to3(t) = poissrnd(MRR_hh1(t)*migrate/2);
    MRR_hR1to3(t) = poissrnd(MRR_hR1(t)*migrate/2);
    MRR_RR1to3(t) = poissrnd(MRR_RR1(t)*migrate/2);

    % Migrants pop 2 -> pop 1:
    MHH2to1(t) = poissrnd(MHH2(t)*migrate/2);
    MHh2to1(t) = poissrnd(MHh2(t)*migrate/2);
    MHR2to1(t) = poissrnd(MHR2(t)*migrate/2);
    Mhh2to1(t) = poissrnd(Mhh2(t)*migrate/2);
    MhR2to1(t) = poissrnd(MhR2(t)*migrate/2);
    MRR2to1(t) = poissrnd(MRR2(t)*migrate/2);

    MHH_HH2to1(t) = poissrnd(MHH_HH2(t)*migrate/2);
    MHH_Hh2to1(t) = poissrnd(MHH_Hh2(t)*migrate/2);
    MHH_HR2to1(t) = poissrnd(MHH_HR2(t)*migrate/2);
    MHH_hh2to1(t) = poissrnd(MHH_hh2(t)*migrate/2);
    MHH_hR2to1(t) = poissrnd(MHH_hR2(t)*migrate/2);
    MHH_RR2to1(t) = poissrnd(MHH_RR2(t)*migrate/2);
    ...
    MHR_HH2to1(t) = poissrnd(MHR_HH2(t)*migrate/2);
    MHR_Hh2to1(t) = poissrnd(MHR_Hh2(t)*migrate/2);
    MHR_HR2to1(t) = poissrnd(MHR_HR2(t)*migrate/2);
    MHR_hh2to1(t) = poissrnd(MHR_hh2(t)*migrate/2);
    MHR_hR2to1(t) = poissrnd(MHR_hR2(t)*migrate/2);
    MHR_RR2to1(t) = poissrnd(MHR_RR2(t)*migrate/2);
    ...
    MRR_HH2to1(t) = poissrnd(MRR_HH2(t)*migrate/2);
    MRR_Hh2to1(t) = poissrnd(MRR_Hh2(t)*migrate/2);
    MRR_HR2to1(t) = poissrnd(MRR_HR2(t)*migrate/2);
    MRR_hh2to1(t) = poissrnd(MRR_hh2(t)*migrate/2);
    MRR_hR2to1(t) = poissrnd(MRR_hR2(t)*migrate/2);
    MRR_RR2to1(t) = poissrnd(MRR_RR2(t)*migrate/2);

    % Migrants pop 2 -> pop 3:
    MHH2to3(t) = poissrnd(MHH2(t)*migrate/2);
    MHh2to3(t) = poissrnd(MHh2(t)*migrate/2);
    MHR2to3(t) = poissrnd(MHR2(t)*migrate/2);
    Mhh2to3(t) = poissrnd(Mhh2(t)*migrate/2);
    MhR2to3(t) = poissrnd(MhR2(t)*migrate/2);
    MRR2to3(t) = poissrnd(MRR2(t)*migrate/2);

    MHH_HH2to3(t) = poissrnd(MHH_HH2(t)*migrate/2);
    MHH_Hh2to3(t) = poissrnd(MHH_Hh2(t)*migrate/2);
    MHH_HR2to3(t) = poissrnd(MHH_HR2(t)*migrate/2);
    MHH_hh2to3(t) = poissrnd(MHH_hh2(t)*migrate/2);
    MHH_hR2to3(t) = poissrnd(MHH_hR2(t)*migrate/2);
    MHH_RR2to3(t) = poissrnd(MHH_RR2(t)*migrate/2);
    ...
    MHR_HH2to3(t) = poissrnd(MHR_HH2(t)*migrate/2);
    MHR_Hh2to3(t) = poissrnd(MHR_Hh2(t)*migrate/2);
    MHR_HR2to3(t) = poissrnd(MHR_HR2(t)*migrate/2);
    MHR_hh2to3(t) = poissrnd(MHR_hh2(t)*migrate/2);
    MHR_hR2to3(t) = poissrnd(MHR_hR2(t)*migrate/2);
    MHR_RR2to3(t) = poissrnd(MHR_RR2(t)*migrate/2);
    ...
    MRR_HH2to3(t) = poissrnd(MRR_HH2(t)*migrate/2);
    MRR_Hh2to3(t) = poissrnd(MRR_Hh2(t)*migrate/2);
    MRR_HR2to3(t) = poissrnd(MRR_HR2(t)*migrate/2);
    MRR_hh2to3(t) = poissrnd(MRR_hh2(t)*migrate/2);
    MRR_hR2to3(t) = poissrnd(MRR_hR2(t)*migrate/2);
    MRR_RR2to3(t) = poissrnd(MRR_RR2(t)*migrate/2);

    % Migrants pop 3 -> pop 1:
    MHH3to1(t) = poissrnd(MHH3(t)*migrate/2);
    MHh3to1(t) = poissrnd(MHh3(t)*migrate/2);
    MHR3to1(t) = poissrnd(MHR3(t)*migrate/2);
    Mhh3to1(t) = poissrnd(Mhh3(t)*migrate/2);
    MhR3to1(t) = poissrnd(MhR3(t)*migrate/2);
    MRR3to1(t) = poissrnd(MRR3(t)*migrate/2);

    MHH_HH3to1(t) = poissrnd(MHH_HH3(t)*migrate/2);
    MHH_Hh3to1(t) = poissrnd(MHH_Hh3(t)*migrate/2);
    MHH_HR3to1(t) = poissrnd(MHH_HR3(t)*migrate/2);
    MHH_hh3to1(t) = poissrnd(MHH_hh3(t)*migrate/2);
    MHH_hR3to1(t) = poissrnd(MHH_hR3(t)*migrate/2);
    MHH_RR3to1(t) = poissrnd(MHH_RR3(t)*migrate/2);
    ...
    MHR_HH3to1(t) = poissrnd(MHR_HH3(t)*migrate/2);
    MHR_Hh3to1(t) = poissrnd(MHR_Hh3(t)*migrate/2);
    MHR_HR3to1(t) = poissrnd(MHR_HR3(t)*migrate/2);
    MHR_hh3to1(t) = poissrnd(MHR_hh3(t)*migrate/2);
    MHR_hR3to1(t) = poissrnd(MHR_hR3(t)*migrate/2);
    MHR_RR3to1(t) = poissrnd(MHR_RR3(t)*migrate/2);
    ...
    MRR_HH3to1(t) = poissrnd(MRR_HH3(t)*migrate/2);
    MRR_Hh3to1(t) = poissrnd(MRR_Hh3(t)*migrate/2);
    MRR_HR3to1(t) = poissrnd(MRR_HR3(t)*migrate/2);
    MRR_hh3to1(t) = poissrnd(MRR_hh3(t)*migrate/2);
    MRR_hR3to1(t) = poissrnd(MRR_hR3(t)*migrate/2);
    MRR_RR3to1(t) = poissrnd(MRR_RR3(t)*migrate/2);

    % Migrants pop 3 -> pop 2:
    MHH3to2(t) = poissrnd(MHH3(t)*migrate/2);
    MHh3to2(t) = poissrnd(MHh3(t)*migrate/2);
    MHR3to2(t) = poissrnd(MHR3(t)*migrate/2);
    Mhh3to2(t) = poissrnd(Mhh3(t)*migrate/2);
    MhR3to2(t) = poissrnd(MhR3(t)*migrate/2);
    MRR3to2(t) = poissrnd(MRR3(t)*migrate/2);

    MHH_HH3to2(t) = poissrnd(MHH_HH3(t)*migrate/2);
    MHH_Hh3to2(t) = poissrnd(MHH_Hh3(t)*migrate/2);
    MHH_HR3to2(t) = poissrnd(MHH_HR3(t)*migrate/2);
    MHH_hh3to2(t) = poissrnd(MHH_hh3(t)*migrate/2);
    MHH_hR3to2(t) = poissrnd(MHH_hR3(t)*migrate/2);
    MHH_RR3to2(t) = poissrnd(MHH_RR3(t)*migrate/2);
    ...
    MHR_HH3to2(t) = poissrnd(MHR_HH3(t)*migrate/2);
    MHR_Hh3to2(t) = poissrnd(MHR_Hh3(t)*migrate/2);
    MHR_HR3to2(t) = poissrnd(MHR_HR3(t)*migrate/2);
    MHR_hh3to2(t) = poissrnd(MHR_hh3(t)*migrate/2);
    MHR_hR3to2(t) = poissrnd(MHR_hR3(t)*migrate/2);
    MHR_RR3to2(t) = poissrnd(MHR_RR3(t)*migrate/2);
    ...
    MRR_HH3to2(t) = poissrnd(MRR_HH3(t)*migrate/2);
    MRR_Hh3to2(t) = poissrnd(MRR_Hh3(t)*migrate/2);
    MRR_HR3to2(t) = poissrnd(MRR_HR3(t)*migrate/2);
    MRR_hh3to2(t) = poissrnd(MRR_hh3(t)*migrate/2);
    MRR_hR3to2(t) = poissrnd(MRR_hR3(t)*migrate/2);
    MRR_RR3to2(t) = poissrnd(MRR_RR3(t)*migrate/2);

    % Exchanging migrants:
    MHH1(t) = MHH1(t) - MHH1to2(t) - MHH1to3(t) + MHH2to1(t) + MHH3to1(t);
    MHh1(t) = MHh1(t) - MHh1to2(t) - MHh1to3(t) + MHh2to1(t) + MHh3to1(t);
    MHR1(t) = MHR1(t) - MHR1to2(t) - MHR1to3(t) + MHR2to1(t) + MHR3to1(t);
    Mhh1(t) = Mhh1(t) - Mhh1to2(t) - Mhh1to3(t) + Mhh2to1(t) + Mhh3to1(t);
    MhR1(t) = MhR1(t) - MhR1to2(t) - MhR1to3(t) + MhR2to1(t) + MhR3to1(t);
    MRR1(t) = MRR1(t) - MRR1to2(t) - MRR1to3(t) + MRR2to1(t) + MRR3to1(t);

    MHH_HH1(t) = MHH_HH1(t) - MHH_HH1to2(t) - MHH_HH1to3(t) + MHH_HH2to1(t) + MHH_HH3to1(t);
    MHH_Hh1(t) = MHH_Hh1(t) - MHH_Hh1to2(t) - MHH_Hh1to3(t) + MHH_Hh2to1(t) + MHH_Hh3to1(t);
    MHH_HR1(t) = MHH_HR1(t) - MHH_HR1to2(t) - MHH_HR1to3(t) + MHH_HR2to1(t) + MHH_HR3to1(t);
    MHH_hh1(t) = MHH_hh1(t) - MHH_hh1to2(t) - MHH_hh1to3(t) + MHH_hh2to1(t) + MHH_hh3to1(t);
    MHH_hR1(t) = MHH_hR1(t) - MHH_hR1to2(t) - MHH_hR1to3(t) + MHH_hR2to1(t) + MHH_hR3to1(t);
    MHH_RR1(t) = MHH_RR1(t) - MHH_RR1to2(t) - MHH_RR1to3(t) + MHH_RR2to1(t) + MHH_RR3to1(t);
    ...
    MHR_HH1(t) = MHR_HH1(t) - MHR_HH1to2(t) - MHR_HH1to3(t) + MHR_HH2to1(t) + MHR_HH3to1(t);
    MHR_Hh1(t) = MHR_Hh1(t) - MHR_Hh1to2(t) - MHR_Hh1to3(t) + MHR_Hh2to1(t) + MHR_Hh3to1(t);
    MHR_HR1(t) = MHR_HR1(t) - MHR_HR1to2(t) - MHR_HR1to3(t) + MHR_HR2to1(t) + MHR_HR3to1(t);
    MHR_hh1(t) = MHR_hh1(t) - MHR_hh1to2(t) - MHR_hh1to3(t) + MHR_hh2to1(t) + MHR_hh3to1(t);
    MHR_hR1(t) = MHR_hR1(t) - MHR_hR1to2(t) - MHR_hR1to3(t) + MHR_hR2to1(t) + MHR_hR3to1(t);
    MHR_RR1(t) = MHR_RR1(t) - MHR_RR1to2(t) - MHR_RR1to3(t) + MHR_RR2to1(t) + MHR_RR3to1(t);
    ...
    MRR_HH1(t) = MRR_HH1(t) - MRR_HH1to2(t) - MRR_HH1to3(t) + MRR_HH2to1(t) + MRR_HH3to1(t);
    MRR_Hh1(t) = MRR_Hh1(t) - MRR_Hh1to2(t) - MRR_Hh1to3(t) + MRR_Hh2to1(t) + MRR_Hh3to1(t);
    MRR_HR1(t) = MRR_HR1(t) - MRR_HR1to2(t) - MRR_HR1to3(t) + MRR_HR2to1(t) + MRR_HR3to1(t);
    MRR_hh1(t) = MRR_hh1(t) - MRR_hh1to2(t) - MRR_hh1to3(t) + MRR_hh2to1(t) + MRR_hh3to1(t);
    MRR_hR1(t) = MRR_hR1(t) - MRR_hR1to2(t) - MRR_hR1to3(t) + MRR_hR2to1(t) + MRR_hR3to1(t);
    MRR_RR1(t) = MRR_RR1(t) - MRR_RR1to2(t) - MRR_RR1to3(t) + MRR_RR2to1(t) + MRR_RR3to1(t);

    
    MHH2(t) = MHH2(t) - MHH2to1(t) - MHH2to3(t) + MHH1to2(t) + MHH3to2(t);
    MHh2(t) = MHh2(t) - MHh2to1(t) - MHh2to3(t) + MHh1to2(t) + MHh3to2(t);
    MHR2(t) = MHR2(t) - MHR2to1(t) - MHR2to3(t) + MHR1to2(t) + MHR3to2(t);
    Mhh2(t) = Mhh2(t) - Mhh2to1(t) - Mhh2to3(t) + Mhh1to2(t) + Mhh3to2(t);
    MhR2(t) = MhR2(t) - MhR2to1(t) - MhR2to3(t) + MhR1to2(t) + MhR3to2(t);
    MRR2(t) = MRR2(t) - MRR2to1(t) - MRR2to3(t) + MRR1to2(t) + MRR3to2(t);

    MHH_HH2(t) = MHH_HH2(t) - MHH_HH2to1(t) - MHH_HH2to3(t) + MHH_HH1to2(t) + MHH_HH3to2(t);
    MHH_Hh2(t) = MHH_Hh2(t) - MHH_Hh2to1(t) - MHH_Hh2to3(t) + MHH_Hh1to2(t) + MHH_Hh3to2(t);
    MHH_HR2(t) = MHH_HR2(t) - MHH_HR2to1(t) - MHH_HR2to3(t) + MHH_HR1to2(t) + MHH_HR3to2(t);
    MHH_hh2(t) = MHH_hh2(t) - MHH_hh2to1(t) - MHH_hh2to3(t) + MHH_hh1to2(t) + MHH_hh3to2(t);
    MHH_hR2(t) = MHH_hR2(t) - MHH_hR2to1(t) - MHH_hR2to3(t) + MHH_hR1to2(t) + MHH_hR3to2(t);
    MHH_RR2(t) = MHH_RR2(t) - MHH_RR2to1(t) - MHH_RR2to3(t) + MHH_RR1to2(t) + MHH_RR3to2(t);
    ...
    MHR_HH2(t) = MHR_HH2(t) - MHR_HH2to1(t) - MHR_HH2to3(t) + MHR_HH1to2(t) + MHR_HH3to2(t);
    MHR_Hh2(t) = MHR_Hh2(t) - MHR_Hh2to1(t) - MHR_Hh2to3(t) + MHR_Hh1to2(t) + MHR_Hh3to2(t);
    MHR_HR2(t) = MHR_HR2(t) - MHR_HR2to1(t) - MHR_HR2to3(t) + MHR_HR1to2(t) + MHR_HR3to2(t);
    MHR_hh2(t) = MHR_hh2(t) - MHR_hh2to1(t) - MHR_hh2to3(t) + MHR_hh1to2(t) + MHR_hh3to2(t);
    MHR_hR2(t) = MHR_hR2(t) - MHR_hR2to1(t) - MHR_hR2to3(t) + MHR_hR1to2(t) + MHR_hR3to2(t);
    MHR_RR2(t) = MHR_RR2(t) - MHR_RR2to1(t) - MHR_RR2to3(t) + MHR_RR1to2(t) + MHR_RR3to2(t);
    ...
    MRR_HH2(t) = MRR_HH2(t) - MRR_HH2to1(t) - MRR_HH2to3(t) + MRR_HH1to2(t) + MRR_HH3to2(t);
    MRR_Hh2(t) = MRR_Hh2(t) - MRR_Hh2to1(t) - MRR_Hh2to3(t) + MRR_Hh1to2(t) + MRR_Hh3to2(t);
    MRR_HR2(t) = MRR_HR2(t) - MRR_HR2to1(t) - MRR_HR2to3(t) + MRR_HR1to2(t) + MRR_HR3to2(t);
    MRR_hh2(t) = MRR_hh2(t) - MRR_hh2to1(t) - MRR_hh2to3(t) + MRR_hh1to2(t) + MRR_hh3to2(t);
    MRR_hR2(t) = MRR_hR2(t) - MRR_hR2to1(t) - MRR_hR2to3(t) + MRR_hR1to2(t) + MRR_hR3to2(t);
    MRR_RR2(t) = MRR_RR2(t) - MRR_RR2to1(t) - MRR_RR2to3(t) + MRR_RR1to2(t) + MRR_RR3to2(t);

    
    MHH3(t) = MHH3(t) - MHH3to1(t) - MHH3to2(t) + MHH1to3(t) + MHH2to3(t);
    MHh3(t) = MHh3(t) - MHh3to1(t) - MHh3to2(t) + MHh1to3(t) + MHh2to3(t);
    MHR3(t) = MHR3(t) - MHR3to1(t) - MHR3to2(t) + MHR1to3(t) + MHR2to3(t);
    Mhh3(t) = Mhh3(t) - Mhh3to1(t) - Mhh3to2(t) + Mhh1to3(t) + Mhh2to3(t);
    MhR3(t) = MhR3(t) - MhR3to1(t) - MhR3to2(t) + MhR1to3(t) + MhR2to3(t);
    MRR3(t) = MRR3(t) - MRR3to1(t) - MRR3to2(t) + MRR1to3(t) + MRR2to3(t);
    
    MHH_HH3(t) = MHH_HH3(t) - MHH_HH3to1(t) - MHH_HH3to2(t) + MHH_HH1to3(t) + MHH_HH2to3(t);
    MHH_Hh3(t) = MHH_Hh3(t) - MHH_Hh3to1(t) - MHH_Hh3to2(t) + MHH_Hh1to3(t) + MHH_Hh2to3(t);
    MHH_HR3(t) = MHH_HR3(t) - MHH_HR3to1(t) - MHH_HR3to2(t) + MHH_HR1to3(t) + MHH_HR2to3(t);
    MHH_hh3(t) = MHH_hh3(t) - MHH_hh3to1(t) - MHH_hh3to2(t) + MHH_hh1to3(t) + MHH_hh2to3(t);
    MHH_hR3(t) = MHH_hR3(t) - MHH_hR3to1(t) - MHH_hR3to2(t) + MHH_hR1to3(t) + MHH_hR2to3(t);
    MHH_RR3(t) = MHH_RR3(t) - MHH_RR3to1(t) - MHH_RR3to2(t) + MHH_RR1to3(t) + MHH_RR2to3(t);
    ...
    MHR_HH3(t) = MHR_HH3(t) - MHR_HH3to1(t) - MHR_HH3to2(t) + MHR_HH1to3(t) + MHR_HH2to3(t);
    MHR_Hh3(t) = MHR_Hh3(t) - MHR_Hh3to1(t) - MHR_Hh3to2(t) + MHR_Hh1to3(t) + MHR_Hh2to3(t);
    MHR_HR3(t) = MHR_HR3(t) - MHR_HR3to1(t) - MHR_HR3to2(t) + MHR_HR1to3(t) + MHR_HR2to3(t);
    MHR_hh3(t) = MHR_hh3(t) - MHR_hh3to1(t) - MHR_hh3to2(t) + MHR_hh1to3(t) + MHR_hh2to3(t);
    MHR_hR3(t) = MHR_hR3(t) - MHR_hR3to1(t) - MHR_hR3to2(t) + MHR_hR1to3(t) + MHR_hR2to3(t);
    MHR_RR3(t) = MHR_RR3(t) - MHR_RR3to1(t) - MHR_RR3to2(t) + MHR_RR1to3(t) + MHR_RR2to3(t);
    ...
    MRR_HH3(t) = MRR_HH3(t) - MRR_HH3to1(t) - MRR_HH3to2(t) + MRR_HH1to3(t) + MRR_HH2to3(t);
    MRR_Hh3(t) = MRR_Hh3(t) - MRR_Hh3to1(t) - MRR_Hh3to2(t) + MRR_Hh1to3(t) + MRR_Hh2to3(t);
    MRR_HR3(t) = MRR_HR3(t) - MRR_HR3to1(t) - MRR_HR3to2(t) + MRR_HR1to3(t) + MRR_HR2to3(t);
    MRR_hh3(t) = MRR_hh3(t) - MRR_hh3to1(t) - MRR_hh3to2(t) + MRR_hh1to3(t) + MRR_hh2to3(t);
    MRR_hR3(t) = MRR_hR3(t) - MRR_hR3to1(t) - MRR_hR3to2(t) + MRR_hR1to3(t) + MRR_hR2to3(t);
    MRR_RR3(t) = MRR_RR3(t) - MRR_RR3to1(t) - MRR_RR3to2(t) + MRR_RR1to3(t) + MRR_RR2to3(t);
end
...
Mf = Mf1 + Mf2 + Mf3;
M = M1 + M2 + M3;
MhomingAllele = MhomingAllele1 + MhomingAllele2 + MhomingAllele3;
MresistantAllele = MresistantAllele1 + MresistantAllele2 + MresistantAllele3;

finalArray = [MhomingAllele; MresistantAllele; M];
strM = 1000000000000;
idString = [int2str(floor(rho*strM)) '_' int2str(floor(e*strM)) '_' int2str(floor(s*strM)) '_' int2str(floor(M_eq*strM*3)) '_' fileID];
